...
*最終確認: 2026-06-11 | ステータス: v1.1 | 種別: 実務ガイドライン（試験対策ページではなく現場作業の標準手順書） | 法令条番号の照合: e-Gov（労働安全衛生規則）2026-06-11 | v1.1: 4視点並列レビュー（法令一次照合・実務監査・新人可読性・規約整合）反映 — 接地線切離し・連結盤・撤去範囲合意・警報マスク等を追補*
