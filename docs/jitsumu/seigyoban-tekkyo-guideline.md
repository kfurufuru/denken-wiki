...
| 作成者 | （運用時に記入） |
| 審査者 | （運用時に記入） |
| 承認者 | （運用時に記入。電気主任技術者または安全衛生責任者） |
| 管理元 | （運用時に記入。原本を管理する部署） |
...
*最終確認: 2026-06-12 | ステータス: v2.0 | 種別: 実務ガイドライン（試験対策ページではなく現場作業の標準手順書） | 法令条番号の照合: e-Gov（労働安全衛生規則）2026-06-11 | v2.0: 世界一流監査3視点（NFPA 70E／OSHA・ISO 45001・国際ベンチマーク実調査）の指摘を反映 — 改訂内容は第13章の改訂履歴を参照*
