...
| 層 | ジャンプ |
|----|---------|
| 🔴 法律 | [なぜ規制するのか](#law-layer) |
| 🟠 政令 | [規制の範囲は？](#cabinet-layer) |
| 🟡 省令 | [何を守るか](#ministerial-layer) |
| 🟢 告示 | [どうやって守るか](#notification-layer) |
| 🔵 規格 | [実務では？](#standard-layer) |

#### 🔴 法律層 — なぜ規制するのか {#law-layer}
...
#### 🟢 告示層 — どうやって守るか {#notification-layer}
