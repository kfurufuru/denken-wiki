...
> 💡 各層のWHY（「答え」列）を理解してから過去問を開く。丸暗記ではなく「なぜその規制があるか」で選択肢を消去法で絞る練習をここでやる。

??? example "🔴 法律層（なぜ規制するのか）→ [第39条](../articles/jigyoho/39.md)・[第42条](../articles/jigyoho/42.md)・[第48条](../articles/jigyoho/48.md)"

    **R05上 問1 — 主任技術者の選任・職務・外部委託制度**

    - **出題形式**: 穴埋め
    - **関連条文**: 事業法§43・施行規則§52
    - **問われた内容**: 事業用電気工作物の設置者は主任技術者を選任し、保安の監督をさせなければならない。外部委託が認められる条件（規模・契約要件）も問われた。
    - **WHYとの接続**: 「電気工作物の危険性を事前に管理する」→ だから**専門家（主任技術者）の常駐**を義務づける。危険な設備を無資格者だけで運転させない仕組み。

    ---

    **H29 問1 — 技術基準への適合義務（39条）と適合命令（40条）**

    - **出題形式**: 穴埋め
    - **関連条文**: 事業法§39・§40
    - **問われた内容**: 事業用電気工作物は技術基準に**常時**適合させる義務がある。基準不適合の場合、経産大臣は修理・改造・使用制限等を命じることができる。
    - **WHYとの接続**: 「事故を未然に防ぐ」→ だから設置時だけでなく**経年劣化後も**基準を維持する義務がある。違反には行政命令で強制是正。

??? example "🟠 政令層（規制の範囲は？）→ [第38条](../articles/jigyoho/38.md)・第57条"

    **H30 問1 — 自家用電気工作物の定義**

    - **出題形式**: 穴埋め
    - **関連条文**: 事業法§38
    - **問われた内容**: 電気工作物の分類（一般用・自家用・電気事業用）の定義。自家用は「高圧以上で受電する需要設備」等。太陽電池発電所の分類も問われた（問2）。
    - **WHYとの接続**: 「電圧が高い＝危険度が高い」→ だから600Vを境に**一般用と自家用を分け**、規制の強度を変える。分類が全ての規制の出発点。

    ---

    **R03 問1 — 一般用電気工作物の調査義務（57条）の主体**

    - **出題形式**: 穴埋め
    - **関連条文**: 事業法§57
    - **問われた内容**: 一般用電気工作物の技術基準適合を調査する義務は**一般送配電事業者等（電力会社）**が負う。設置者（一般家庭）ではない。
    - **WHYとの接続**: 「一般家庭には専門知識がない」→ だから**電力会社が定期的に調査に来る**制度にした。❌「設置者が調査する」は頻出ひっかけ。

??? example "🟡 省令層（何を守るか）→ 施行規則第50条・第62条"

    **R05下 問1 — 保安規程に定める事項（施行規則第50条）**

    - **出題形式**: 穴埋め
    - **関連条文**: 事業法§42・施行規則§50
    - **問われた内容**: 保安規程に記載すべき事項（保安業務の管理体制、従事者の職務範囲、運転・操作、災害対策、保安教育、記録の保存）の穴埋め。
    - **WHYとの接続**: 法律は「保安規程を定めよ」（42条）、省令は「**具体的にこの6項目を書け**」（施行規則50条）。抽象→具体の階層構造そのもの。

    ---

    **R02 問1 — 発電事業用電気工作物の保安規程**

    - **出題形式**: 穴埋め
    - **関連条文**: 施行規則§50
    - **問われた内容**: R05下とほぼ同じ論点。保安規程の記載事項を条文ベースで穴埋め。
    - **WHYとの接続**: 同上。事業場ごとの実態に合わせた安全管理体制を文書化する仕組み。

??? example "🟢 告示層（どうやって守るか）→ [第42条](../articles/jigyoho/42.md)・[第47条](../articles/jigyoho/47.md)・[第48条](../articles/jigyoho/48.md)"

    **R04上 問1 — 受電電圧7000V以下の保安体系**

    - **出題形式**: 穴埋め
    - **関連条文**: 事業法§43・施行規則§52
    - **問われた内容**: 主任技術者の選任義務と、一定規模以下の自家用で認められる外部委託制度の要件。
    - **WHYとの接続**: 「届出＝出せばOK」vs「認可＝許可待ち」。**手続きの重さが設備リスクに比例する**設計。小規模なら外部委託という柔軟な運用手段がある。

    ---

    **H28 問1 — 主任技術者を選任しなくてよい条件**

    - **出題形式**: 論説
    - **関連条文**: 施行規則§52第2項
    - **問われた内容**: 自家用電気工作物のうち、出力・電圧が一定以下の場合に主任技術者の選任を不要とできる条件（外部委託の要件）。
    - **WHYとの接続**: 「リスクが低ければ規制を緩和する」→ 全設備一律ではなく、**危険度に応じた段階的規制**の具体例。

??? example "🔵 規格層（実務では？）→ 4法比較"

    **R01 問1 — 電気事業の定義と登録・許可**

    - **出題形式**: 穴埋め
    - **関連条文**: 事業法§2・§2の2・§3
    - **問われた内容**: 一般送配電事業・小売電気事業・発電事業等の定義と、それぞれに必要な登録・許可の区別。
    - **WHYとの接続**: 「設備・人・業者・製品を別の法律で管轄する」→ まず**事業法の中での事業者分類**を押さえないと4法比較の土台が作れない。
