...
??? example "R05上期 問1 — 主任技術者の選任・職務（§43）｜正答: (4)"
...
??? example "H29 問1 — 技術基準適合義務と適合命令（§39・§40）｜正答: (4)"
...
??? example "H30 問1 — 自家用電気工作物の定義（§38）｜正答: (2)"
...
??? example "R05下期 問1 — 保安規程に定める事項（施行規則§50）｜正答: (4)"
...
??? example "R02 問1 — 発電事業用の保安規程（施行規則§50）｜正答: (1)ハ (2)ホ (3)ヲ (4)ヘ (5)ワ"
...
??? example "R04上期 問1 — 受電電圧7000V以下の保安体系（§43・施行規則§52）｜正答: (4)"
...
??? example "H28 問1 — 主任技術者を選任しなくてよい条件（施行規則§52）｜正答: (2)"
...
??? example "R01 問1 — 電気事業の定義と登録・許可（§2）｜正答: (1)"
