...
**🔴 法律層（なぜ規制するのか）** → [第39条](../articles/jigyoho/39.md)・[第42条](../articles/jigyoho/42.md)・[第48条](../articles/jigyoho/48.md)

| 過去問 | 何が問われたか | WHYとの接続 |
|--------|--------------|------------|
| [R05上](../kakomon/R05.md) 問1 | 主任技術者の選任・職務・外部委託制度 | 「危険な設備には専門家が必要」→ だから43条で選任義務がある |
| [H29](../kakomon/H29.md) 問1 | 技術基準への適合義務（39条）と適合命令（40条） | 「事故を未然に防ぐ」→ だから常時適合＋違反時は行政命令 |

**🟠 政令層（規制の範囲は？）** → [第38条](../articles/jigyoho/38.md)・第57条

| 過去問 | 何が問われたか | WHYとの接続 |
|--------|--------------|------------|
| [H30](../kakomon/H30.md) 問1 | 自家用電気工作物の定義（高圧以上で受電等） | 「電圧が高い＝危険度が高い」→ だから分類して規制の強度を変える |
| [R03](../kakomon/R03.md) 問1 | 一般用電気工作物の調査義務（57条）の主体 | 「一般家庭には専門知識がない」→ だから電力会社が調査する義務を負う |

**🟡 省令層（何を守るか）** → 施行規則第50条・第62条

| 過去問 | 何が問われたか | WHYとの接続 |
|--------|--------------|------------|
| [R05下](../kakomon/R05.md) 問1 | 保安規程に定める事項（施行規則第50条の6項目） | 「法律は"何を守るか"、省令は"具体的に何を書くか"」を決める |
| [R02](../kakomon/R02.md) 問1 | 発電事業用電気工作物の保安規程に規定すべき事項 | 同上。事業場ごとの実態に合わせた安全管理体制を文書化する |

**🟢 告示層（どうやって守るか）** → [第42条](../articles/jigyoho/42.md)・[第47条](../articles/jigyoho/47.md)・[第48条](../articles/jigyoho/48.md)

| 過去問 | 何が問われたか | WHYとの接続 |
|--------|--------------|------------|
| [R04上](../kakomon/R04.md) 問1 | 受電電圧7000V以下の保安体系（主任技術者・外部委託） | 「届出＝出せばOK」vs「認可＝許可待ち」。手続きの重さが設備リスクに比例する |
| [H28](../kakomon/H28.md) 問1 | 主任技術者を選任しなくてよい自家用の条件 | 「小規模なら外部委託でOK」→ リスクに応じて運用手段を柔軟にする仕組み |

**🔵 規格層（実務では？）** → 4法比較

| 過去問 | 何が問われたか | WHYとの接続 |
|--------|--------------|------------|
| [R01](../kakomon/R01.md) 問1 | 電気事業の定義（一般送配電・小売等）と登録・許可 | 「設備・人・業者・製品を別の法律で管轄」→ 4法を混同しない |

> 💡 **使い方**: WHY表の「答え」を読んでから「WHYとの接続」を照合する。丸暗記ではなく「なぜその規制があるか」で選択肢を消去法で絞る練習をここでやる。
