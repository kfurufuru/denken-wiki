...
| 年度 | 問 | 形式 | 何が問われたか | 条文 |
|------|---|------|-------------|------|
| R07下 | 問8 | 論説 | 感電・火災等の防止（配線の使用電線・施設方法の原則）| 省令第21条・第56条・第59条・第61条 |
| R02 | 問6 | 択一 | 低圧屋内配線の施設場所による工事の種類 | 解釈第156条 |
| — | — | — | **SoT に解釈第158条（合成樹脂管工事）の出題は登録なし**（旧版の「R04問7」は kakomon.yml では上期＝解釈第187条・下期＝解釈第162条であり、本項の実績ではない） |
| R01 | 問5 | 択一 | 低圧幹線の過電流遮断器の定格 ✅ | 解釈第170条 |
| H29 | 問7 | 択一 | 低圧幹線の施設 ✅ | 解釈第148条 |
| H24 | 問9 | 択一 | 低圧屋内配線の電線及び遮断器 ✅ | 解釈第148条・第149条 |
