...
| 年度 | 問 | 形式 | 何が問われたか | 条文 |
|------|---|------|-------------|------|
| R07下 | 問8 | 論説 | 感電・火災等の防止（配線の使用電線・施設方法の原則）| 省令§56・§57 |
...
### R07下 問8 — 感電・火災等の防止（省令§56・§57）の論説

R07下問8は省令§56・§57を直接問う論説型問題。これまでの出題（解釈第156条以降の具体的な工事方法）とは異なり、**省令レベルの原則的義務**が問われた。
...
!!! note "R07下問8の出題論点"
    - §56は「感電・火災を防止する施設」であるのに対し、§57は「使用電線の材料・品質要件」という役割の違い
    - 「省令§56が義務づけるのは施設方法、§57は電線の種類・品質」という区別
    - 解釈第156条以降の具体的な工事種類の規定は、省令§56・§57を受けて定められているという階層関係

!!! warning "§56と§57の混同に注意"
    - §56: **施設の方法**（どのように配線するか）= 感電・漏電・短絡を防ぐ施設義務
    - §57: **使用する電線の要件**（どんな電線を使うか）= 温度・化学的劣化への耐性
    
    試験では「§56は電線の品質要件を定める」という誤り選択肢が出る。§56は施設方法、§57が電線品質。
