...
| 法令 | 条文 | テーマ | 出題回数 | 重要度 |
|------|------|--------|---------|--------|
| 電気工事士法 | 第3条 | 資格区分・作業範囲 | 7回 | ★★★★☆ |
| 電気関係報告規則 | 第3条 | 事故報告（速報・詳報） | 7回 | ★★★★☆ |
| 電気用品安全法 | 第10条 | PSEマーク（◇○の区分） | 5回 | ★★★☆☆ |
| 電気工事業法 | 第3条 | 登録要件・主任電気工事士 | 4回 | ★★★☆☆ |
...
| 条文 | テーマ | 出題回数 | 重要度 |
|------|--------|---------|--------|
| 第17条 | 接地工事の種類及び施設方法（A〜D種） | 11回 | ★★★★★ |
| 第18条 | 工作物の金属体を利用した接地工事 | 10回 | ★★★★★ |
...
- [その他法令 条文一覧](../articles/other/index.md)
- [罰則・罰金比較表](../reference/penalties.md)
- [届出・申請期限一覧](../reference/deadlines.md)
