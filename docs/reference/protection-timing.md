...
|----------|---------------------|-----------------|
| ✅ ==30A 以下== | ==60分==以内に動作しないこと ＋ ==60分==以内に動作 | ==2分以内== |
| ✅ ==30A 超〜50A 以下== | ==60分==以内に動作しないこと ＋ ==60分==以内に動作 | ==4分以内== |
| ✅ ==50A 超〜100A 以下== | ==120分==以内に動作しないこと ＋ ==120分==以内に動作 | ==6分以内== |
| ✅ ==100A 超〜225A 以下== | ==120分==以内に動作しないこと ＋ ==120分==以内に動作 | ==8分以内== |
