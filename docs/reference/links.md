...
- [電気工事業の業務の適正化に関する法律](https://laws.e-gov.go.jp/law/345AC0000000096) — 工事業者の登録・主任電気工事士の選任根拠として頻出だが links.md に未収載だった
---
...
> このセクションでは、解釈条文中で「○○規程による」と参照される民間規格・規程をまとめる。
...
> このセクションでは、公式試験情報と過去問解説サイトを掲載する。
...
- [電験超入門部 — 電験3種 法規（条文解説・計算B問題・過去問R1〜R7）](https://denken.joho.info/denken3-hoki/) — 省令全条文・解釈のテーマ別解説＋B問題計算＋R1〜R7過去問解説を備えた第2解説ソース。論点照合・解法ステップ参考に有用（条文文言の一次照合源にはしない／正本はe-Gov・過去問はdenken-ou.com）。kaishaku/14 の『漏えい電流1mA以下＝解釈第14条第1項』を独立に裏付け。jiko-1.md で既に過去問照合に使用実績あり
---
...
*最終更新: 2026-05-10（リファクタ：3セクション → 7セクション・LawId 表記統一・eGov API 罠ガイド追加・発電用5技術基準/電気工事業法/公害防止組織法/JEAC/JESC を新規収載・ローカルキャッシュ表追加・監査スクリプト一覧整備）*
