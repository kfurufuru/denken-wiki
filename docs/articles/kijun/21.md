...
| **典拠（一次ソース）** | 電気設備に関する技術基準を定める省令（平成九年通商産業省令第五十二号、令和5年改正版）第21条 — e-Gov 法令検索 API（lawid=409M50000400052） |
| **照合日** | 2026-05-03（e-Gov API で条文原文2項構成＋条見出しを照合・一致確認） |
| **隣接条文** | ← [第20条（電線路等の感電・火災防止）](20.md) ／ 第22条（低圧電線路の絶縁性能）（記事未作成） → |
| **混同注意** | 同番号の **電気事業法第21条**／**[解釈第21条（高圧の機械器具の施設）](../kaishaku/21.md)** とは **別物**（特に解釈第21条 取り違えの誤記事件 2026-05-05 が起きており要警戒）。本条は「電技省令」第21条（架空・地中電線の感電防止） |
...
<div><svg viewBox="0 0 800 380" xmlns="http://www.w3.org/2000/svg" width="100%" preserveAspectRatio="xMidYMid meet">
<defs>
<filter id="sh21r" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="2" stdDeviation="2" flood-opacity="0.2"/></filter>
<linearGradient id="cu21r" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#ffd180"/><stop offset="50%" stop-color="#ef6c00"/><stop offset="100%" stop-color="#bf360c"/></linearGradient>
<linearGradient id="vinG21" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#81c784"/><stop offset="100%" stop-color="#2e7d32"/></linearGradient>
<linearGradient id="vinW21" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#fafafa"/><stop offset="100%" stop-color="#bdbdbd"/></linearGradient>
<linearGradient id="vinR21" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#ef5350"/><stop offset="100%" stop-color="#b71c1c"/></linearGradient>
<linearGradient id="vinK21" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#616161"/><stop offset="100%" stop-color="#212121"/></linearGradient>
<linearGradient id="sheath21r" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#424242"/><stop offset="100%" stop-color="#000"/></linearGradient>
</defs>
<text x="400" y="26" text-anchor="middle" font-size="15" font-weight="700" fill="#212121">実物イメージ — 絶縁電線（2層）vs ケーブル（3層）</text>
<text x="400" y="44" text-anchor="middle" font-size="11" fill="#666">先端を剥いて中身を見る／シース（外被）の有無が地中可否の境界</text>
<line x1="400" y1="60" x2="400" y2="370" stroke="#bdbdbd" stroke-width="1" stroke-dasharray="4,3"/>
<rect x="20" y="60" width="360" height="310" rx="10" fill="#e8f5e9" stroke="#a5d6a7" stroke-width="1.5"/>
<text x="200" y="84" text-anchor="middle" font-size="14" font-weight="700" fill="#1b5e20">絶縁電線（2層構造）</text>
<text x="200" y="102" text-anchor="middle" font-size="10" fill="#2e7d32">代表: 600Vビニル絶縁電線 IV・OW・DV</text>
<rect x="40" y="158" width="220" height="28" rx="4" fill="url(#vinG21)" stroke="#1b5e20" stroke-width="1.5" filter="url(#sh21r)"/>
<polygon points="255,158 268,172 255,186" fill="#1b5e20"/>
<rect x="260" y="168" width="68" height="8" fill="url(#cu21r)" stroke="#bf360c" stroke-width="1"/>
<circle cx="330" cy="172" r="4.5" fill="#ef6c00" stroke="#bf360c" stroke-width="1"/>
<line x1="150" y1="158" x2="150" y2="147" stroke="#1b5e20" stroke-width="1.2"/>
<circle cx="150" cy="158" r="3" fill="#1b5e20"/>
<text x="150" y="130" text-anchor="middle" font-size="11" font-weight="700" fill="#1b5e20">① 絶縁体</text>
<text x="150" y="143" text-anchor="middle" font-size="9" fill="#2e7d32">（ビニル被覆1層）</text>
<line x1="295" y1="172" x2="295" y2="210" stroke="#bf360c" stroke-width="1.2"/>
<circle cx="295" cy="172" r="3" fill="#bf360c"/>
<text x="295" y="223" text-anchor="middle" font-size="11" font-weight="700" fill="#bf360c">② 導体（銅）</text>
<text x="200" y="252" text-anchor="middle" font-size="9.5" fill="#558b2f">実物：用途で色分け（緑/白/赤/黒）</text>
<rect x="50" y="260" width="100" height="6" rx="1" fill="url(#vinG21)"/>
<rect x="150" y="261.5" width="20" height="3" fill="url(#cu21r)"/>
<rect x="50" y="270" width="100" height="6" rx="1" fill="url(#vinW21)" stroke="#9e9e9e" stroke-width="0.5"/>
<rect x="150" y="271.5" width="20" height="3" fill="url(#cu21r)"/>
<rect x="50" y="280" width="100" height="6" rx="1" fill="url(#vinR21)"/>
<rect x="150" y="281.5" width="20" height="3" fill="url(#cu21r)"/>
<rect x="50" y="290" width="100" height="6" rx="1" fill="url(#vinK21)"/>
<rect x="150" y="291.5" width="20" height="3" fill="url(#cu21r)"/>
<rect x="190" y="255" width="180" height="50" rx="6" fill="#fff9c4" stroke="#f9a825" stroke-width="1.5"/>
<text x="280" y="272" text-anchor="middle" font-size="10" font-weight="700" fill="#f57f17">耐候性○ / 損傷△ / 防水△</text>
<text x="280" y="290" text-anchor="middle" font-size="10" font-weight="600" fill="#1b5e20">第21条：架空＝可</text>
<text x="280" y="302" text-anchor="middle" font-size="10" font-weight="700" fill="#c62828">　　地中＝不可</text>
<rect x="40" y="320" width="320" height="38" rx="6" fill="#c8e6c9" stroke="#2e7d32" stroke-width="1.5"/>
<text x="200" y="340" text-anchor="middle" font-size="11" font-weight="700" fill="#1b5e20">層は「導体＋被覆」の2つだけ</text>
<text x="200" y="354" text-anchor="middle" font-size="9.5" fill="#2e7d32">→ 土中の機械的損傷・薬品攻撃に耐えられない</text>
<rect x="420" y="60" width="360" height="310" rx="10" fill="#fbe9e7" stroke="#ffab91" stroke-width="1.5"/>
<text x="600" y="84" text-anchor="middle" font-size="14" font-weight="700" fill="#bf360c">ケーブル（3層構造）</text>
<text x="600" y="102" text-anchor="middle" font-size="10" fill="#d84315">代表: CV・CVT・VVF（外被＝シース付）</text>
<rect x="440" y="142" width="170" height="44" rx="8" fill="url(#sheath21r)" stroke="#212121" stroke-width="1.5" filter="url(#sh21r)"/>
<polygon points="605,142 622,164 605,186" fill="#000"/>
<rect x="615" y="152" width="78" height="24" rx="3" fill="url(#vinR21)" stroke="#b71c1c" stroke-width="1.5"/>
<polygon points="690,152 702,164 690,176" fill="#b71c1c"/>
<rect x="695" y="160" width="55" height="8" fill="url(#cu21r)" stroke="#bf360c" stroke-width="1"/>
<circle cx="752" cy="164" r="4.5" fill="#ef6c00" stroke="#bf360c" stroke-width="1"/>
<line x1="525" y1="142" x2="525" y2="134" stroke="#212121" stroke-width="1.2"/>
<circle cx="525" cy="142" r="3" fill="#212121"/>
<text x="525" y="130" text-anchor="middle" font-size="11" font-weight="700" fill="#212121">③ シース（外被）</text>
<line x1="655" y1="152" x2="655" y2="134" stroke="#b71c1c" stroke-width="1.2"/>
<circle cx="655" cy="152" r="3" fill="#b71c1c"/>
<text x="655" y="130" text-anchor="middle" font-size="11" font-weight="700" fill="#b71c1c">② 絶縁体</text>
<line x1="720" y1="164" x2="720" y2="210" stroke="#bf360c" stroke-width="1.2"/>
<circle cx="720" cy="164" r="3" fill="#bf360c"/>
<text x="720" y="223" text-anchor="middle" font-size="11" font-weight="700" fill="#bf360c">① 導体（銅）</text>
<text x="490" y="250" text-anchor="middle" font-size="9.5" fill="#bf360c">複数心の例：3心CVケーブル断面</text>
<circle cx="490" cy="285" r="28" fill="url(#sheath21r)" stroke="#212121" stroke-width="1.5"/>
<circle cx="490" cy="272" r="9.5" fill="url(#vinR21)" stroke="#b71c1c" stroke-width="0.8"/>
<circle cx="490" cy="272" r="3.5" fill="url(#cu21r)"/>
<circle cx="479" cy="294" r="9.5" fill="url(#vinW21)" stroke="#9e9e9e" stroke-width="0.8"/>
<circle cx="479" cy="294" r="3.5" fill="url(#cu21r)"/>
<circle cx="501" cy="294" r="9.5" fill="url(#vinK21)" stroke="#212121" stroke-width="0.8"/>
<circle cx="501" cy="294" r="3.5" fill="url(#cu21r)"/>
<rect x="550" y="260" width="220" height="55" rx="6" fill="#ffe0b2" stroke="#ef6c00" stroke-width="1.5"/>
<text x="660" y="278" text-anchor="middle" font-size="10" font-weight="700" fill="#bf360c">耐候性○ / 損傷○ / 防水○ / 耐薬品○</text>
<text x="660" y="294" text-anchor="middle" font-size="10" font-weight="600" fill="#1b5e20">第21条：架空＝可</text>
<text x="660" y="308" text-anchor="middle" font-size="10" font-weight="700" fill="#1b5e20">　　地中＝必須</text>
<rect x="440" y="320" width="320" height="38" rx="6" fill="#fbe9e7" stroke="#bf360c" stroke-width="1.5"/>
<text x="600" y="340" text-anchor="middle" font-size="11" font-weight="700" fill="#bf360c">「導体＋絶縁体＋シース」の3層（シースが最大の差分）</text>
<text x="600" y="354" text-anchor="middle" font-size="9.5" fill="#d84315">→ シースが地中の過酷環境（土圧・水分・薬品）に耐える</text>
</svg></div>

**読み解き**: 写真でよく見る IV線（緑/白/赤/黒の単色ビニル線）は **2層構造**（導体＋ビニル被覆1層）で、先端を剥くと銅がそのまま出てくる。一方ケーブルは **シース（外被）＋絶縁体＋導体の3層**で、先端を剥くとシース→色付き絶縁体→銅が階段状に現れる。**シース（外被）の有無**が地中で使えるかどうかの境界。
...
<div><svg viewBox="0 0 880 520" xmlns="http://www.w3.org/2000/svg" width="100%" preserveAspectRatio="xMidYMid meet">
<defs>
<filter id="sh21f" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="2" stdDeviation="2" flood-opacity="0.15"/></filter>
<linearGradient id="gQ21" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#bbdefb"/><stop offset="100%" stop-color="#90caf9"/></linearGradient>
<linearGradient id="gOK21" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#c8e6c9"/><stop offset="100%" stop-color="#a5d6a7"/></linearGradient>
<linearGradient id="gOnly21" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#d7ccc8"/><stop offset="100%" stop-color="#a1887f"/></linearGradient>
<linearGradient id="gExc21f" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#fff9c4"/><stop offset="100%" stop-color="#fff176"/></linearGradient>
<linearGradient id="gOut21" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#eeeeee"/><stop offset="100%" stop-color="#bdbdbd"/></linearGradient>
<marker id="ar21f" markerWidth="10" markerHeight="10" refX="8" refY="5" orient="auto"><polygon points="0 0,9 5,0 10" fill="#0d47a1"/></marker>
</defs>
<text x="440" y="26" text-anchor="middle" font-size="15" font-weight="700" fill="#212121">第21条 判定フロー — 施設箇所 → 電圧 → 結果</text>
<text x="440" y="44" text-anchor="middle" font-size="11" fill="#666">「どこに施設するか」を最初に決めると残りは一直線</text>
<rect x="340" y="60" width="200" height="58" rx="12" fill="url(#gQ21)" stroke="#0d47a1" stroke-width="2.5" filter="url(#sh21f)"/>
<text x="440" y="84" text-anchor="middle" font-size="12" font-weight="700" fill="#0d47a1">Q1. 施設箇所は？</text>
<text x="440" y="104" text-anchor="middle" font-size="11" fill="#1565c0">架空 or 地中</text>
<line x1="380" y1="118" x2="220" y2="158" stroke="#0d47a1" stroke-width="2" marker-end="url(#ar21f)"/>
<text x="280" y="140" text-anchor="middle" font-size="11" font-weight="700" fill="#0d47a1">架空</text>
<line x1="500" y1="118" x2="660" y2="158" stroke="#0d47a1" stroke-width="2" marker-end="url(#ar21f)"/>
<text x="600" y="140" text-anchor="middle" font-size="11" font-weight="700" fill="#0d47a1">地中</text>
<rect x="100" y="160" width="240" height="58" rx="12" fill="url(#gQ21)" stroke="#0d47a1" stroke-width="2" filter="url(#sh21f)"/>
<text x="220" y="184" text-anchor="middle" font-size="12" font-weight="700" fill="#0d47a1">Q2. 電圧階級は？</text>
<text x="220" y="204" text-anchor="middle" font-size="11" fill="#1565c0">低圧/高圧 or 特別高圧</text>
<line x1="170" y1="218" x2="100" y2="265" stroke="#0d47a1" stroke-width="2" marker-end="url(#ar21f)"/>
<text x="120" y="246" text-anchor="middle" font-size="10" font-weight="700" fill="#0d47a1">低圧/高圧</text>
<line x1="270" y1="218" x2="340" y2="265" stroke="#0d47a1" stroke-width="2" marker-end="url(#ar21f)"/>
<text x="320" y="246" text-anchor="middle" font-size="10" font-weight="700" fill="#0d47a1">特別高圧</text>
<rect x="20" y="270" width="200" height="80" rx="12" fill="url(#gQ21)" stroke="#0d47a1" stroke-width="2" filter="url(#sh21f)"/>
<text x="120" y="294" text-anchor="middle" font-size="12" font-weight="700" fill="#0d47a1">Q3. ただし書き</text>
<text x="120" y="312" text-anchor="middle" font-size="11" fill="#0d47a1">該当する？</text>
<text x="120" y="330" text-anchor="middle" font-size="9" fill="#1565c0">通常予見される使用形態で</text>
<text x="120" y="342" text-anchor="middle" font-size="9" fill="#1565c0">感電のおそれがない</text>
<line x1="80" y1="350" x2="110" y2="395" stroke="#0d47a1" stroke-width="2" marker-end="url(#ar21f)"/>
<text x="62" y="376" text-anchor="middle" font-size="10" font-weight="700" fill="#0d47a1">No</text>
<text x="62" y="388" text-anchor="middle" font-size="9" fill="#1565c0">（通常）</text>
<line x1="160" y1="350" x2="320" y2="395" stroke="#0d47a1" stroke-width="2" marker-end="url(#ar21f)"/>
<text x="250" y="354" text-anchor="middle" font-size="10" font-weight="700" fill="#0d47a1">Yes</text>
<text x="250" y="366" text-anchor="middle" font-size="9" fill="#1565c0">（例外）</text>
<rect x="280" y="270" width="180" height="80" rx="12" fill="url(#gOut21)" stroke="#616161" stroke-width="2" filter="url(#sh21f)"/>
<text x="370" y="296" text-anchor="middle" font-size="13" font-weight="700" fill="#424242">第21条 対象外</text>
<text x="370" y="318" text-anchor="middle" font-size="10" fill="#616161">特別高圧架空電線は</text>
<text x="370" y="332" text-anchor="middle" font-size="10" fill="#616161">解釈第79条等で別規定</text>
<text x="370" y="346" text-anchor="middle" font-size="9" fill="#9e9e9e">（本条の判定対象外）</text>
<rect x="540" y="160" width="240" height="80" rx="12" fill="url(#gOnly21)" stroke="#5d4037" stroke-width="3" filter="url(#sh21f)"/>
<text x="660" y="186" text-anchor="middle" font-size="13" font-weight="700" fill="#3e2723">地中電線（全電圧）</text>
<line x1="560" y1="194" x2="760" y2="194" stroke="#5d4037" stroke-width="1"/>
<text x="660" y="216" text-anchor="middle" font-size="15" font-weight="800" fill="#3e2723">ケーブル のみ</text>
<text x="660" y="232" text-anchor="middle" font-size="9" fill="#5d4037">例外なし・電圧階級問わず</text>
<rect x="20" y="400" width="180" height="76" rx="12" fill="url(#gOK21)" stroke="#2e7d32" stroke-width="3" filter="url(#sh21f)"/>
<text x="110" y="424" text-anchor="middle" font-size="12" font-weight="700" fill="#1b5e20">通常パターン</text>
<line x1="40" y1="432" x2="180" y2="432" stroke="#2e7d32" stroke-width="1"/>
<text x="110" y="452" text-anchor="middle" font-size="12" font-weight="800" fill="#1b5e20">絶縁電線 又は ケーブル</text>
<text x="110" y="468" text-anchor="middle" font-size="9" fill="#2e7d32">（裸電線は不可）</text>
<rect x="230" y="400" width="180" height="76" rx="12" fill="url(#gExc21f)" stroke="#f9a825" stroke-width="2.5" filter="url(#sh21f)"/>
<text x="320" y="424" text-anchor="middle" font-size="12" font-weight="700" fill="#f57f17">例外パターン</text>
<line x1="250" y1="432" x2="390" y2="432" stroke="#f9a825" stroke-width="1"/>
<text x="320" y="452" text-anchor="middle" font-size="11" font-weight="700" fill="#f57f17">裸電線 も可</text>
<text x="320" y="468" text-anchor="middle" font-size="9" fill="#f57f17">（感電のおそれなし限定）</text>
<rect x="120" y="496" width="640" height="20" rx="4" fill="#e3f2fd" stroke="#1565c0" stroke-width="1"/>
<text x="440" y="510" text-anchor="middle" font-size="10" fill="#0d47a1">共通要件: いずれの場合も「使用電圧に応じた絶縁性能」を有すること</text>
</svg></div>

**読み解き — 3ステップで決まる**:

1. **施設箇所** で大分岐 → 地中なら即「ケーブル のみ」（電圧階級も例外も不要）
2. 架空なら **電圧階級** で確認 → 特別高圧は本条対象外（別条文）
3. 低圧・高圧の架空なら **ただし書き例外** の有無で結果が決まる → 通常は「絶縁電線 又は ケーブル」、例外時のみ裸電線も可

!!! tip "覚え方の要点"
    - **地中 → 即ケーブル**（考えることがほぼない・例外もなし）
    - **架空 → 電圧と例外の2段階確認**
    - 「特別高圧架空が対象外」は本条で**判定しない**領域（解釈第79条等の別ルール）
...
- **2026-05-05（v2.2 UX改修）**: ユーザフィードバックに基づき2点改善。(1) 第4条 に絶縁電線 vs ケーブル の **断面図SVG**（同心円構造）を追加し、シース（外被）の有無が地中可否の境界であることを視覚化。(2) 第5条 判定フローを **mermaid → SVG** に置き換え、「施設箇所→電圧→例外」の3ステップ構造と「地中＝即ケーブル／架空＝2段階確認」の判断軸を明示。
- **数値検証判定: N/A**（原則規定・材料規定のため数値テーブルなし）
- **2026-05-05 v2.3 テンプレートv2.3移行**: メタテーブルに「典拠／照合日／隣接条文／混同注意」4行追加。フッタにステータスラベル3軸（条文番号／出題実績／数値根拠）導入。**特に解釈第21条 取り違え誤記事件（2026-05-05）の教訓を反映し、混同注意行で省令第21条 vs 解釈第21条 を明示分離**。
    - **条文番号確定根拠**: 電技省令 平成九年通商産業省令第五十二号 令和5年改正版（e-Gov API lawid=409M50000400052・2026-05-03取得済）
    - **既存wiki参照の独立検証**: 実施（隣接 第20条・第22条 と内容重複なきこと確認・本条は「架空＝2択／地中＝ケーブル一択」固有内容）
    - **未確認領域**: なし（直接出題実績は未確認スタブだが省令本文確定済）

---

*最終確認: 2026-05-05 | ステータス: v2.3（テンプレートv2.3移行・誤記事件教訓反映で混同注意強化） | 条文番号: ✅ 一次ソース照合済（e-Gov API） ｜ 出題実績: ⚠️ 直接出題実績未確認（kakomon DBに該当なし・関連条文の参照対象） ｜ 数値根拠: — 該当なし（原則規定・材料規定） ｜ [バージョニング基準](../../reference/versioning.md)*
