...
!!! note "📊 試験対策メタ"
    **出題頻度**: 🔥🔥🔥（過去14年で 3 回＝第1条単独1〔R06上問3〕＋総則レンジ2〔R01・R04下〕。旧「6回」は§5・§10/§11問題の誤計上を 2026-06-10 訂正）
...
- **2026-06-10 v2.10 過去問実績の誤計上を訂正（6回→3回）**: kijun/58.md 虚偽引用横断監査で発見。旧版（2026-05-05）が「省令第1条〜第4条 総則レンジ6回」としていた6問のうち4問が別条文の出題だった（kakomon.yml＋denken-ou houkir5-2-3/houkir6-2-3/houkih23-3 で確定）：R05下問3・R06下問3＝省令第5条（電路の絶縁）、H23問3・R07下問3＝省令第10・11条（保安原則＝電位上昇・接地・大地に通ずる）。第1条の実績は **第1条単独1回（R06上問3・光ファイバ定義）＋総則レンジ2回（R01・R04下）の計3回** に訂正。R06上問3（§1単独）は未計上だったため追加。出題頻度メタ・直近出題・blockquote・試験での扱い・marker凡例・出題予測・実績テーブル・フッタを一括是正。

---

*最終確認: 2026-06-10 | ステータス: v2.10（過去問実績の誤計上訂正・6回→3回）｜ 条文番号: ✅ 一次ソース照合済（電技省令第1条 全19号 lawid=409M50000400052） ｜ 出題実績: ✅ kakomon DB 照合済（第1条単独1：R06上問3／総則レンジ2：R01・R04下。旧計上のR05下問3・R06下問3＝§5、H23問3・R07下問3＝§10/§11は別条文として除外） ｜ 数値根拠: — 該当なし（用語定義条文・数値規定なし） ｜ [バージョニング基準](../../reference/versioning.md)*
