...
> 電技の出発点となる用語定義（全19号）。**電路**・**電気機械器具**・**発電所**・**変電所**・**開閉所**・**電線**・**電線路** など、法令全体で使われる言葉の意味を確定する条文。第1条**単独**の出題はないが、**第1条〜第4条 総則レンジ**として H23・R01・R04下・R05下・R06下・R07下と頻出しており、用語定義は保安原則と一体で問われる。
...
*最終確認: 2026-05-10 | ステータス: v2.9（Phase B：接続点削除・全19号構成整備）｜ 条文番号: ✅ 一次ソース照合済（電技省令第1条 全19号 lawid=409M50000400052） ｜ 出題実績: ✅ kakomon DB 6件照合済（第1条〜第4条総則レンジ：H23/R01/R04下/R05下/R06下/R07下） ｜ 数値根拠: — 該当なし（用語定義条文・数値規定なし） ｜ [バージョニング基準](../../reference/versioning.md)*
