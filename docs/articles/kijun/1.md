...
!!! note "📊 試験対策メタ"
    **出題頻度**: 🔥🔥🔥（過去14年で 3 回＝第1条単独1〔R06上問3〕＋総則レンジ2〔R01・R04下〕。旧「6回」は第5条・第10条/第11条問題の誤計上を 2026-06-10 訂正）

    **重要度**: A（法令全体の用語供給＝総則の起点）

    **直近出題**: R06上 問3（穴埋・第1条単独＝光ファイバケーブルの定義）

> 電技の出発点となる用語定義（全19号）。**電路**・**電気機械器具**・**発電所**・**変電所**・**開閉所**・**電線**・**電線路** など、法令全体で使われる言葉の意味を確定する条文。第1条**単独**では R06上問3（光ファイバケーブルの定義）で出題され、**第1条〜第4条 総則レンジ**としても R01・R04下 で出題されている。用語定義は保安原則（第10・11条）・電路の絶縁（第5条）等と一体で問われる。

| 項目 | 内容 |
|------|------|
| 条文 | 電気設備技術基準 第1条 |
| 規定内容 | 電路・電気機械器具・発電所・蓄電所・変電所・開閉所・電線・電車線・電線路 等 全19号の用語定義 |
| 性格 | 用語定義（法令全体の前提・他条文への語彙供給） |
| 試験での扱い | 第1条単独（R06上問3・光ファイバ定義）＋総則レンジ（R01・R04下）。**変成・通常・含まない**等のキーワードに注意 |
| 関連条文 | 第2条（電圧種別）・第3〜4条（保安原則）・第5条（電路絶縁）・第12条（混触防止） |
| **典拠（一次ソース）** | 電気設備に関する技術基準を定める省令（平成九年通商産業省令第五十二号、令和5年改正版）第1条 — 経産省 e-Gov 法令検索（lawid: 409M50000400052） |
| **照合日** | 2026-05-10（eGov第1条 全19号を一次ソース照合・「接続点」が省令第1条に存在しないことを確認） |
...
| **電線** | 強電流電気の伝送に使用する電気導体・絶縁物で被覆した電気導体・これらを束ねたもの（第7号） |
...
!!! note "条文原文の照合状況"
    e-Gov公式（lawid=**409M50000400052**・電気設備に関する技術基準を定める省令）第1条 全19号を **2026-05-10 に一次ソース照合済**。本ページでは出題上重要な用語に重点を置いて掲載するが、19号構成（下表）が **省令第1条の正式範囲**。
...
| 三 | 発電所 | 発電機、原動機、燃料電池、太陽電池その他の機械器具（**小規模発電設備・非常用予備電源用・携帯用発電機を除く**）を施設して電気を発生させる所をいう |
| 四 | 蓄電所 | 構外から伝送される**電力**を **構内に施設した**電力貯蔵装置その他の電気工作物により貯蔵し、**当該伝送された電力と同一の使用電圧及び周波数で**さらに構外に伝送する所（同一構内で発電設備・変電設備・需要設備と電気的に接続されているものを除く）をいう |
| 五 | 変電所 | 構外から伝送される電気を **構内に施設した変圧器・回転変流機・整流器その他の電気機械器具により** <mark>変成</mark> する所であって、変成した電気をさらに構外に伝送するもの（**蓄電所を除く**）をいう |
| 六 | 開閉所 | **構内に施設した開閉器その他の装置により電路を開閉する所**であって、**発電所、蓄電所、変電所及び需要場所以外のもの**をいう（＝電気を <mark>変成しない</mark> 点が変電所との違い） |
| 七 | **電線** | 強電流電気の伝送に使用する電気導体、絶縁物で被覆した電気導体又は絶縁物で被覆した上を保護被覆で保護した電気導体をいう |
| 八 | 電車線 | 電気機関車及び電車にその動力用の電気を供給するために使用する接触電線及び鋼索鉄道の車両内の信号装置、照明装置等に電気を供給するために使用する接触電線をいう |
| 九 | 電線路 | 発電所、蓄電所、変電所、開閉所及びこれらに類する場所並びに電気使用場所相互間の電線（**電車線を除く**）並びにこれを支持し、又は保蔵する工作物をいう |
| 十 | 電車線路 | 電車線及びこれを支持する工作物をいう |
| 十一 | 調相設備 | 無効電力を調整する電気機械器具をいう |
| 十二 | 弱電流電線 | 弱電流電気の伝送に使用する電気導体、絶縁物で被覆した電気導体又は絶縁物で被覆した上を保護被覆で保護した電気導体をいう |
| 十三 | 弱電流電線路 | 弱電流電線及びこれを支持し、又は保蔵する工作物（**造営物の屋内又は屋側に施設するものを除く。**）をいう |
| 十四 | 光ファイバケーブル | 光信号の伝送に使用する伝送媒体であって、保護被覆で保護したものをいう |
| 十五 | 光ファイバケーブル線路 | 光ファイバケーブル及びこれを支持し、又は保蔵する工作物（**造営物の屋内又は屋側に施設するものを除く。**）をいう |
| 十六 | 支持物 | 木柱、鉄柱、鉄筋コンクリート柱及び鉄塔並びにこれらに類する工作物であって、電線又は弱電流電線若しくは光ファイバケーブルを支持することを主たる目的とするものをいう |
| 十七 | 連接引込線 | **一需要場所の引込線**（架空電線路の支持物から他の支持物を経ないで需要場所の取付け点に至る架空電線、及び需要場所の造営物の側面等に施設して引込口に至る電線）**から分岐して、支持物を経ないで他の需要場所の引込口に至る部分の電線**をいう |
| 十八 | 配線 | 電気使用場所において施設する電線（電気機械器具内の電線及び電線路の電線を除く。）をいう |
| 十九 | 電力貯蔵装置 | 電力を貯蔵する電気機械器具をいう |

> <small>🟡 黄色マーカー = 第1条**単独**の実出題は R06上問3（光ファイバケーブルの定義＝被覆・支持が実空欄）のみ。本ページがマークするその他の用語（電路・変電所 等）は **総則レンジ穴埋め（R01・R04下等）での空欄候補** に基づく**想定マーキング**である点に注意。</small>

!!! warning "「接続点」は省令第1条の用語ではない（混同注意）"
    学習教材によっては「接続点」が省令第1条の定義語として紹介されることがあるが、**電気設備技術基準を定める省令 第1条（全19号）に「接続点」は存在しない**（2026-05-10 eGov 一次ソース照合済）。

    「接続点」は **電気事業法施行規則・需給規程・解釈第220条系（分散型電源の系統連系）** で使われる用語であり、**省令第1条の範囲外**。責任分界点の文脈で登場するが、本ページの第1条解説では扱わない。
...
| 開閉所 | 構内に施設した開閉器その他の装置により **電路を開閉** する所（発電所・蓄電所・変電所・需要場所以外） | 想定空欄＝**電路を開閉**。「変成しない」は変電所との対比を覚えるための補助語で、条文の文言ではない |
| 電線（第7号） | 強電流電気の伝送に使用する電気導体（絶縁物被覆を含む） | 電線路（第9号）と混同注意：電線は導体本体、電線路は電線＋支持物の一式 |
...
| 電気を入り切りする設備 | 電路を開閉する | 開閉所のキーワード | 変電所と区別が必須（「変成しない」は補助語であって条文語ではない） | 構内に施設した開閉器その他の装置により電路を開閉する所であって、発電所、蓄電所、変電所及び需要場所以外のもの |
| 電線そのもの（導体） | 電線（第7号） | 強電流電気の伝送に使用する電気導体 | 電線（第7号）と電線路（第9号）の混同 | 強電流電気の伝送に使用する電気導体 |
...
| **変成する（変電所）／電路を開閉する（開閉所）** | 変電所と開閉所を分ける条文語。「変成しない」は理解の補助 |
| **電線路** | 電線 ＋ 支持物等の一式 |
...
電線路の定義に **支持物等** が含まれるのは、保安の対象として **電柱・鉄塔・腕金・がいし** 等の支持構造物も一体管理する必要があるため。電線が切れて落下する事故は、支持物の不良が原因のことが多い。**現場** での施工・点検も電線と支持物を一体で扱うのが原則。

### 実務イメージ — 用語定義が現場でどう効くか

第1条の用語は試験用の抽象規定に見えるが、**実務** では以下のように直結する。

| 場面 | 第1条の用語が効く理由 |
|------|------|
| 設備 **設計** 図面のレビュー | 「変電所」と「開閉所」を取り違えると、変圧器有無の単線結線図が破綻する |
| 高圧受電設備の **施工** 仕様策定 | 「電路」と「機器外箱」の弁別がそのまま絶縁工事と接地工事の責任分界になる |
| 保安規程の **実務** 運用 | 「電線路」に支持物が含まれることで、現場点検チェックリストに電柱・がいし類が必須項目化される |
...
!!! note "出題予測（過去14年の統計）"
    第1条の単独出題は **1回**（R06上問3・光ファイバケーブルの定義）、**「省令第1条〜第4条」総則レンジ** としては R01・R04下の **2回**。旧計上の R05下問3・R06下問3 は **省令第5条**（電路の絶縁）、H23問3・R07下問3 は **省令第10・11条**（保安原則）の出題で本条の実績ではない（2026-06-10 denken-ou 一次照合）。
    ...
    4. **想定空欄パターン**: 「変電所とは構外から伝送される電気を（　）する所」
       - 正解: 変成
       - 開閉所側の条文語は「**電路を開閉する**」（「変成しない」は対比を覚えるための補助語）

??? question "📝 ここまでの理解チェック: 第1条〜第4条 総則レンジで問われやすい第1条の語は？"
    **電路・変成（変電所）・電路を開閉する（開閉所）** の3語が中心。総則レンジ出題では第1条用語と第3〜4条の保安原則語句が混在するため、用語定義を曖昧にすると複数空欄で連鎖失点する。
...
!!! abstract "問題（学習用構成問題・難易度 ★★☆☆☆）"
    過去14年で第1条の単独出題はないが、定義語が他条文の穴埋めで問われる場合に備えた **学習用構成問題**。
    次の文章は「電気設備技術基準」第1条の用語定義に関する記述である。空欄（ア）〜（ウ）に入る語句として正しいものを選べ。

    > 「電路」とは，<mark>（ア）</mark> の使用状態で電気が通じているところをいう。
    > 「変電所」とは，構外から伝送される電気を構内に施設した変圧器，回転変流機，整流器その他の電気機械器具により <mark>（イ）</mark> する所であって， <mark>（イ）</mark> した電気をさらに構外に伝送するもの（蓄電所を除く。）をいう。
    > 「開閉所」とは，構内に施設した開閉器その他の装置により <mark>（ウ）</mark> を開閉する所であって，発電所，蓄電所，変電所及び需要場所以外のものをいう。
...
??? success "解答を見る"
    ...
    **読み解きポイント：**
    ...
    - （イ）**変成** ：変電所の核心キーワード。変圧器等による電圧変換
    - （ウ）**電路** ：開閉所の定義は「開閉器その他の装置により**電路**を開閉する所」。「変成しない所」は理解の補助であって条文の文言ではない（第6号の条文は「構内に施設した開閉器その他の装置により電路を開閉する所であって、発電所、蓄電所、変電所及び需要場所以外のもの」）
...
> **補足**: 「接続点」（電気事業者と需要家の電気設備の接続点／責任分界点）は **省令第1条の用語ではない**。電気事業法施行規則・需給規程・解釈第220条系（分散型電源の系統連系）で用いられる用語であり、第1条範囲外。

**サイト内学習ルート（次に読むページ）**

- [保安原則テーマページ](../../themes/hoan-gensoku.md) — 第1条の用語が支える保安原則（第3条〜第4条）の全体整理
- [法規攻略戦略 index](../../strategy/index.md) — 法規科目の攻略戦略・学習順序ガイド
- [用語集（glossary）](../../reference/glossary.md) — 電技用語の横断辞書。第1条定義語を別角度から復習
- [条文番号マッピング](../../reference/article-number-mapping.md) — 省令・解釈・電気事業法の条番号対応表
...
| 年度 | 問 | 形式 | 論点 | 範囲 |
|------|-----|------|------|------|
| R06上 | 問3 | 穴埋 | 光ファイバケーブル／同線路の定義 | 省令第1条（第14・15号）＝**第1条単独** |
| R04下 | 問2 | 穴埋 | 電気設備技術基準に規定されているもの | 省令第1条〜第4条 |
| R01 | 問3 | 論説 | 電気設備技術基準の総則 | 省令第1条〜第4条 |

!!! warning "出題実績の訂正（2026-06-10 denken-ou 一次照合）"
    旧版は R05下問3・R06下問3・H23問3・R07下問3 の4問も「省令第1条〜第4条」の実績に数え「6回」としていたが、いずれも**別条文の出題**だった（kakomon.yml＋denken-ou で確定）。第1条（用語定義）の実績は **第1条単独1回（R06上問3）＋総則レンジ2回（R01問3・R04下問2）の計3回**。下表参照。

### 旧版で誤計上していた4問の正しい出典

- **R05下問3・R06下問3** → **省令第5条**（電路の絶縁の原則と例外）
- **H23問3・R07下問3** → **省令第10・11条**（電気設備の保安原則＝電位上昇・接地・大地に通ずる）

→ **第1条の実績は計3回**（単独1＝R06上／総則レンジ2＝R01・R04下）。問3ポジションでは総則・保安原則（第10・11条）・電路の絶縁（第5条）の基礎法令が連続して出ており、用語定義の曖昧さが連鎖失点に繋がる構造。

!!! note "R08 出題予測"
    問3ポジションでは総則（第1〜4条）・保安原則（第10・11条）・電路の絶縁（第5条）の基礎法令が毎年のように出題されており、R08でも周辺条文込みでの出題可能性が高い。第1条単独では R06上問3（光ファイバケーブルの定義）の形で出ている。
    穴埋では「電路は **通常の使用状態** で電気が通じているところ」「**変成** する所」等の第1条キーワードが空欄になりやすい。
    論説では用語定義の入れ替え（変電所⇄開閉所、構外⇄構内）が誤り選択肢として混入する典型パターン。
    **学習戦略**: 第1条（用語定義）を起点に、保安原則（第10・11条）・電路の絶縁（第5条）まで基礎法令ブロックとして一体で押さえる。
...
- **2026-08-28 監査是正**（ChatGPT/Fable 監査 → Claude 一次照合）: 用語定義表の逐語是正。柱書「用語の**意義**は」→「用語の**定義**は」。第4号（蓄電所）の「変電所等以外の場所に施設した」を条文どおり「構内に施設した…同一の使用電圧及び周波数で」に、第6号（開閉所）を「構内に施設した開閉器その他の装置により電路を開閉する所であって、発電所、蓄電所、変電所及び需要場所以外のもの」に訂正（従来の「構外から伝送される電気の開閉を行うが変成しない所」は現行条文に存在しない）。第13号の除外括弧を「電気通信事業法…電気通信回線設備」→「造営物の屋内又は屋側に施設するもの」に是正。第3・5・9・15・17号の欠落括弧を補完。セクション10の学習用構成問題も同じ誤定義を前提にしていたため設問・解答を差し替え。典拠: e-Gov XML `scripts/cache/egov-409M50000400052.xml` 逐語照合。
...
- **2026-05-05 v2.8 テンプレートv2.3移行**: メタテーブルに「典拠／照合日／隣接条文／混同注意」4行追加。フッタにステータスラベル3軸（条文番号／出題実績／数値根拠）導入。
    ...
    - **未確認領域**: なし
- **2026-05-10 v2.6必須ブロック改修**: I11（サイト学習ルート4本追加・攻略戦略リンク含む）／I18（!!! abstract「学習用構成問題」へ昇格）／I15（実務イメージ表追加・施工/現場/設計/実務キーワード補強）の3点改修。本文既存内容は無削除・追記のみ。S-rank 90+ 到達確認済。
- **2026-05-10 v2.9 Phase B修正**：『接続点』を第1条第7号扱いから削除（**省令第1条19号に存在しない**・eGov法令API lawid=409M50000400052 で全19号一次ソース照合済）。第7号は『**電線**』が正。条文原文テーブル（セクション2）を全19号構成に再整理（電路・電気機械器具・発電所・蓄電所・変電所・開閉所・電線・電車線・電線路・電車線路・調相設備・弱電流電線・弱電流電線路・光ファイバケーブル・光ファイバケーブル線路・支持物・連接引込線・配線・電力貯蔵装置）。「接続点」は電気事業法施行規則・需給規程・解釈第220条系の用語であることを セクション2 末尾と セクション12 末尾の補足注記で明示。メタ表 lawid を旧 337M50000400052 → 現行 **409M50000400052** に修正・照合日 2026-05-10 更新。セクション1要点・セクション3原文解析・セクション4法規特有表現・セクション12関連条文の「接続点」関連行を「電線」関連に置換または削除。
- **2026-06-10 v2.10 過去問実績の誤計上を訂正（6回→3回）**: kijun/58.md 虚偽引用横断監査で発見。旧版（2026-05-05）が「省令第1条〜第4条 総則レンジ6回」としていた6問のうち4問が別条文の出題だった（kakomon.yml＋denken-ou houkir5-2-3/houkir6-2-3/houkih23-3 で確定）：R05下問3・R06下問3＝省令第5条（電路の絶縁）、H23問3・R07下問3＝省令第10・11条（保安原則＝電位上昇・接地・大地に通ずる）。第1条の実績は **第1条単独1回（R06上問3・光ファイバ定義）＋総則レンジ2回（R01・R04下）の計3回** に訂正。R06上問3（第1条単独）は未計上だったため追加。出題頻度メタ・直近出題・blockquote・試験での扱い・marker凡例・出題予測・実績テーブル・フッタを一括是正。

---

*最終確認: 2026-06-10 | ステータス: v2.10（過去問実績の誤計上訂正・6回→3回）｜ 条文番号: ✅ 一次ソース照合済（電技省令第1条 全19号 lawid=409M50000400052） ｜ 出題実績: ✅ kakomon DB 照合済（第1条単独1：R06上問3／総則レンジ2：R01・R04下。旧計上のR05下問3・R06下問3＝第5条、H23問3・R07下問3＝第10条/第11条は別条文として除外） ｜ 数値根拠: — 該当なし（用語定義条文・数値規定なし） ｜ [バージョニング基準](../../reference/versioning.md)*
