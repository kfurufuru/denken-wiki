...
!!! note "📊 試験対策メタ"
    **出題頻度**: 🔥🔥🔥（過去14年で 6 回・「省令§1〜§4」総則レンジ出題として頻出）

    **重要度**: A（保安原則の総則として直近6年で4回連続出題）

    **直近出題**: R07下 問3（穴埋・§1〜§4 総則レンジ）

> 電技の出発点となる用語定義。**電路**・**電線路**・**変電所**・**開閉所** など、法令全体で使われる言葉の意味を確定する条文。第1条**単独**の出題はないが、**§1〜§4 総則レンジ**として H23・R01・R04下・R05下・R06下・R07下と頻出しており、用語定義は保安原則と一体で問われる。
...
| 試験での扱い | §1〜§4 総則レンジ出題で **変成・通常・含まない**等のキーワードが頻出。直近6年で4回連続出題 |
...
> <small>🟡 黄色マーカー = 第1条**単独**の出題実績はないが、**§1〜§4 総則レンジ穴埋め**（H23・R04下・R05下・R07下等）で空欄候補となる蓋然性が高い語句。**第1条単独出題ベースの実マーキングではなく、総則レンジ出題に基づく想定マーキング**である点に注意。</small>
...
<div><svg viewBox="0 0 820 490" xmlns="http://www.w3.org/2000/svg" font-family="-apple-system,BlinkMacSystemFont,Hiragino Kaku Gothic ProN,Yu Gothic UI,Meiryo,sans-serif" style="width:100%;max-width:820px"><defs><filter id="shD3" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="2" stdDeviation="2" flood-opacity="0.15"/></filter><linearGradient id="gHV3" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#ffcdd2"/><stop offset="100%" stop-color="#ef9a9a"/></linearGradient><linearGradient id="gLV3" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#fff9c4"/><stop offset="100%" stop-color="#fff59d"/></linearGradient><linearGradient id="gC3" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#bbdefb"/><stop offset="100%" stop-color="#90caf9"/></linearGradient><marker id="arrD3" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><polygon points="0 0,8 3,0 6" fill="#666"/></marker></defs><text x="410" y="26" text-anchor="middle" font-size="15" font-weight="700" fill="#212121">⚙️ 電気機械器具の具体例 — 電路上に配置される代表機器</text><text x="410" y="44" text-anchor="middle" font-size="11" fill="#666">第1条「電気機械器具＝電路を構成する機械器具」の中身</text><circle cx="40" cy="100" r="22" fill="none" stroke="#c62828" stroke-width="2"/><text x="40" y="105" text-anchor="middle" font-size="11" fill="#c62828">電源</text><line x1="62" y1="100" x2="92" y2="100" stroke="#666" stroke-width="2"/><rect x="92" y="80" width="56" height="40" rx="4" fill="url(#gHV3)" stroke="#c62828" stroke-width="1.5" filter="url(#shD3)"/><text x="120" y="96" text-anchor="middle" font-size="9" font-weight="700" fill="#b71c1c">避雷器</text><text x="120" y="110" text-anchor="middle" font-size="8" fill="#5d4037">LA</text><text x="120" y="138" text-anchor="middle" font-size="8" fill="#666">雷サージ吸収</text><line x1="148" y1="100" x2="170" y2="100" stroke="#666" stroke-width="2"/><rect x="170" y="80" width="56" height="40" rx="4" fill="url(#gHV3)" stroke="#c62828" stroke-width="1.5" filter="url(#shD3)"/><text x="198" y="96" text-anchor="middle" font-size="9" font-weight="700" fill="#b71c1c">断路器</text><text x="198" y="110" text-anchor="middle" font-size="8" fill="#5d4037">DS</text><text x="198" y="138" text-anchor="middle" font-size="8" fill="#666">無電流時開閉</text><line x1="226" y1="100" x2="248" y2="100" stroke="#666" stroke-width="2"/><rect x="248" y="80" width="56" height="40" rx="4" fill="url(#gHV3)" stroke="#c62828" stroke-width="1.5" filter="url(#shD3)"/><text x="276" y="96" text-anchor="middle" font-size="9" font-weight="700" fill="#b71c1c">遮断器</text><text x="276" y="110" text-anchor="middle" font-size="8" fill="#5d4037">CB</text><text x="276" y="138" text-anchor="middle" font-size="8" fill="#666">故障時遮断</text><line x1="304" y1="100" x2="326" y2="100" stroke="#666" stroke-width="2"/><rect x="326" y="80" width="56" height="40" rx="4" fill="url(#gC3)" stroke="#0d47a1" stroke-width="1.5" filter="url(#shD3)"/><text x="354" y="96" text-anchor="middle" font-size="9" font-weight="700" fill="#0d47a1">CT/VT</text><text x="354" y="110" text-anchor="middle" font-size="8" fill="#5d4037">計器用</text><text x="354" y="138" text-anchor="middle" font-size="8" fill="#666">電圧電流計測</text><line x1="382" y1="100" x2="404" y2="100" stroke="#666" stroke-width="2"/><rect x="404" y="70" width="80" height="60" rx="6" fill="url(#gC3)" stroke="#0d47a1" stroke-width="2" filter="url(#shD3)"/><text x="444" y="92" text-anchor="middle" font-size="11" font-weight="700" fill="#0d47a1">変圧器</text><text x="444" y="108" text-anchor="middle" font-size="9" fill="#0d47a1">TR</text><text x="444" y="123" text-anchor="middle" font-size="8" fill="#5d4037">高圧→低圧</text><text x="444" y="148" text-anchor="middle" font-size="8" fill="#666">変成（電圧変換）</text><line x1="484" y1="100" x2="510" y2="100" stroke="#666" stroke-width="2"/><rect x="510" y="70" width="70" height="60" rx="6" fill="#fff3e0" stroke="#ef6c00" stroke-width="2" filter="url(#shD3)"/><text x="545" y="92" text-anchor="middle" font-size="11" font-weight="700" fill="#e65100">配電盤</text><text x="545" y="115" text-anchor="middle" font-size="9" fill="#5d4037">機器集約</text><text x="545" y="148" text-anchor="middle" font-size="8" fill="#666">分電・制御</text><line x1="580" y1="100" x2="606" y2="100" stroke="#666" stroke-width="2"/><rect x="606" y="80" width="64" height="40" rx="4" fill="url(#gLV3)" stroke="#f9a825" stroke-width="1.5" filter="url(#shD3)"/><text x="638" y="96" text-anchor="middle" font-size="9" font-weight="700" fill="#bf360c">開閉器</text><text x="638" y="110" text-anchor="middle" font-size="8" fill="#5d4037">SW+ヒューズ</text><text x="638" y="138" text-anchor="middle" font-size="8" fill="#666">通電制御</text><line x1="670" y1="100" x2="696" y2="100" stroke="#666" stroke-width="2" marker-end="url(#arrD3)"/><circle cx="730" cy="100" r="28" fill="#e8f5e9" stroke="#2e7d32" stroke-width="2" filter="url(#shD3)"/><text x="730" y="98" text-anchor="middle" font-size="14" font-weight="700" fill="#1b5e20">M</text><text x="730" y="112" text-anchor="middle" font-size="9" fill="#1b5e20">電動機</text><text x="730" y="148" text-anchor="middle" font-size="8" fill="#666">負荷</text><line x1="20" y1="180" x2="800" y2="180" stroke="#bdbdbd" stroke-width="1" stroke-dasharray="3,3"/><text x="410" y="200" text-anchor="middle" font-size="12" font-weight="700" fill="#424242">📚 機能別分類カード</text><rect x="20" y="215" width="150" height="160" rx="10" fill="#e3f2fd" stroke="#0d47a1" stroke-width="1.8" filter="url(#shD3)"/><text x="95" y="240" text-anchor="middle" font-size="20">🔄</text><text x="95" y="262" text-anchor="middle" font-size="12" font-weight="700" fill="#0d47a1">変成装置</text><line x1="35" y1="270" x2="155" y2="270" stroke="#0d47a1" stroke-width="1"/><text x="95" y="290" text-anchor="middle" font-size="10" font-weight="600" fill="#5d4037">・変圧器 (TR)</text><text x="95" y="308" text-anchor="middle" font-size="10" font-weight="600" fill="#5d4037">・計器用変成器</text><text x="95" y="324" text-anchor="middle" font-size="9" fill="#5d4037">  (CT・VT)</text><text x="95" y="350" text-anchor="middle" font-size="9" fill="#1565c0" font-style="italic">電圧・電流を変える</text><text x="95" y="365" text-anchor="middle" font-size="9" fill="#1565c0" font-style="italic">／計測用に変換</text><rect x="180" y="215" width="150" height="160" rx="10" fill="#ffebee" stroke="#c62828" stroke-width="1.8" filter="url(#shD3)"/><text x="255" y="240" text-anchor="middle" font-size="20">⚡</text><text x="255" y="262" text-anchor="middle" font-size="12" font-weight="700" fill="#b71c1c">開閉装置</text><line x1="195" y1="270" x2="315" y2="270" stroke="#c62828" stroke-width="1"/><text x="255" y="288" text-anchor="middle" font-size="10" font-weight="600" fill="#5d4037">・遮断器 (CB)</text><text x="255" y="304" text-anchor="middle" font-size="10" font-weight="600" fill="#5d4037">・断路器 (DS)</text><text x="255" y="320" text-anchor="middle" font-size="10" font-weight="600" fill="#5d4037">・開閉器 (SW)</text><text x="255" y="336" text-anchor="middle" font-size="10" font-weight="600" fill="#5d4037">・ヒューズ</text><text x="255" y="362" text-anchor="middle" font-size="9" fill="#c62828" font-style="italic">電流の通断を制御</text><rect x="340" y="215" width="150" height="160" rx="10" fill="#fff3e0" stroke="#ef6c00" stroke-width="1.8" filter="url(#shD3)"/><text x="415" y="240" text-anchor="middle" font-size="20">🛡️</text><text x="415" y="262" text-anchor="middle" font-size="12" font-weight="700" fill="#e65100">保護装置</text><line x1="355" y1="270" x2="475" y2="270" stroke="#ef6c00" stroke-width="1"/><text x="415" y="290" text-anchor="middle" font-size="10" font-weight="600" fill="#5d4037">・避雷器 (LA)</text><text x="415" y="306" text-anchor="middle" font-size="10" font-weight="600" fill="#5d4037">・SPD</text><text x="415" y="322" text-anchor="middle" font-size="10" font-weight="600" fill="#5d4037">・保護継電器</text><text x="415" y="350" text-anchor="middle" font-size="9" fill="#e65100" font-style="italic">異常電圧・電流から</text><text x="415" y="365" text-anchor="middle" font-size="9" fill="#e65100" font-style="italic">設備を保護</text><rect x="500" y="215" width="150" height="160" rx="10" fill="#e8f5e9" stroke="#2e7d32" stroke-width="1.8" filter="url(#shD3)"/><text x="575" y="240" text-anchor="middle" font-size="20">⚙️</text><text x="575" y="262" text-anchor="middle" font-size="12" font-weight="700" fill="#1b5e20">負荷装置</text><line x1="515" y1="270" x2="635" y2="270" stroke="#2e7d32" stroke-width="1"/><text x="575" y="290" text-anchor="middle" font-size="10" font-weight="600" fill="#5d4037">・電動機 (M)</text><text x="575" y="306" text-anchor="middle" font-size="10" font-weight="600" fill="#5d4037">・照明器具</text><text x="575" y="322" text-anchor="middle" font-size="10" font-weight="600" fill="#5d4037">・電熱器</text><text x="575" y="338" text-anchor="middle" font-size="10" font-weight="600" fill="#5d4037">・コンデンサ</text><text x="575" y="365" text-anchor="middle" font-size="9" fill="#2e7d32" font-style="italic">電気を機械力・熱・光に</text><rect x="660" y="215" width="150" height="160" rx="10" fill="#f3e5f5" stroke="#6a1b9a" stroke-width="1.8" filter="url(#shD3)"/><text x="735" y="240" text-anchor="middle" font-size="20">📦</text><text x="735" y="262" text-anchor="middle" font-size="12" font-weight="700" fill="#4a148c">集合装置</text><line x1="675" y1="270" x2="795" y2="270" stroke="#6a1b9a" stroke-width="1"/><text x="735" y="288" text-anchor="middle" font-size="10" font-weight="600" fill="#5d4037">・配電盤</text><text x="735" y="304" text-anchor="middle" font-size="10" font-weight="600" fill="#5d4037">・分電盤</text><text x="735" y="320" text-anchor="middle" font-size="10" font-weight="600" fill="#5d4037">・制御盤</text><text x="735" y="336" text-anchor="middle" font-size="10" font-weight="600" fill="#5d4037">・開閉器箱</text><text x="735" y="362" text-anchor="middle" font-size="9" fill="#6a1b9a" font-style="italic">複数機器を集約</text><rect x="40" y="395" width="740" height="80" rx="10" fill="#fff8e1" stroke="#f9a825" stroke-width="2" filter="url(#shD3)"/><text x="410" y="418" text-anchor="middle" font-size="12" font-weight="700" fill="#bf360c">🔑 第1条のキモ</text><text x="410" y="438" text-anchor="middle" font-size="11" fill="#5d4037">これらすべてが「電路を構成する機械器具」 ＝ <tspan font-weight="700" fill="#bf360c">電気機械器具</tspan></text><text x="410" y="458" text-anchor="middle" font-size="10" fill="#5d4037">⚠️ 機器の <tspan font-weight="700" fill="#c62828">金属製外箱（フレーム）</tspan> は <tspan font-weight="700" fill="#c62828">非充電部</tspan> なので電気機械器具ではない（→ A・C・D種接地の対象）</text></svg></div>

> **読み解き**: 上段の単線結線図で、電源から負荷（電動機）までの **電路上に配置される代表機器** を一望できる。下段の5カテゴリで **機能別** に分類。**変成・開閉・保護・負荷・集合** の5機能すべてが電気機械器具に含まれる。
...
> 出題パターンは「§1〜§4 総則レンジの穴埋め・論説」。第1条単独ではなく、保安原則（§3〜§4）と一体で問われる。

!!! note "出題予測（過去14年の統計）"
    第1条の単独出題は **0回** だが、**「省令§1〜§4」総則レンジ** として H23・R01・R04下・R05下・R06下・R07下の **6回** 出題されている（直近6年で4回連続）。

    1. **総則レンジ穴埋め（最頻出）**: 「電気設備の保安原則」を題材に §1〜§4 から複数空欄
...
??? question "📝 ここまでの理解チェック: §1〜§4 総則レンジで問われやすい第1条の語は？"
...
| 年度 | 問 | 形式 | 論点 | 範囲 |
|------|-----|------|------|------|
| H23 | 問3 | 穴埋 | 電気設備の保安原則 | 省令§1〜§4 |
| R01 | 問3 | 論説 | 電気設備技術基準の総則 | 省令§1〜§4 |
| R04下 | 問2 | 穴埋 | 電気設備技術基準に規定されているもの | 省令§1〜§4 |
| R05下 | 問3 | 穴埋 | 電気設備技術基準に規定される保安原則 | 省令§1〜§4 |
| R06下 | 問3 | 論説 | 電気設備技術基準の保安原則 | 省令§1〜§4 |
| R07下 | 問3 | 穴埋 | 電気設備の保安原則 | 省令§1〜§4 |

→ **§1〜§4 総則レンジで6回出題**。**直近6年で4回連続**（R04下・R05下・R06下・R07下）。第1条単独の問題は無いが、用語定義の曖昧さが直接失点に繋がる構造。

!!! note "R08 出題予測"
    R04下から **4年連続** で§1〜§4総則レンジが出題されており、R08でも継続出題の可能性が高い。
    ...
    **学習戦略**: §1〜§4をひとまとめのブロックとして暗記し、用語定義（§1）と保安原則（§3〜§4）を一体で押さえる。
...
- **2026-05-05（過去問実績修正）**: 当初「単独出題0件」と記載していたが、kakomon.yml で「省令§1〜§4」総則レンジとして6回出題（H23/R01/R04下/R05下/R06下/R07下）が確認されたため、出題頻度を ★☆☆☆☆ → 🔥🔥🔥（重要度A）に修正。過去問実績テーブル・R08予測も更新。
- **数値検証判定: PASS**（用語定義条文・数値なし）
- **`<mark>` 運用**: 第1条**単独**の出題実績は0件のため、原文中のマーカーは **想定空欄候補** として配置（§1〜§4総則レンジ出題の中で第1条用語が空欄になる蓋然性は高いが、第1条単独出題ベースの実マーキングではない点を section 2 凡例で明示）。

---

*最終確認: 2026-05-05 | 数値検証完了: 2026-05-05（PASS・用語定義条文・数値なし） | ステータス: v2.7（テンプレート世代揃え・全体像4タブ・カード集導入） | [バージョニング基準](../../reference/versioning.md)*
