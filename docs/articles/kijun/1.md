...
| 四 | 蓄電所 | 構外から伝送される電気を変電所等以外の場所に施設した電力貯蔵装置に貯蔵し、当該電気を構外に伝送する所をいう |
| 五 | 変電所 | 構外から伝送される電気を <mark>変成</mark> する所であって、変成した電気をさらに構外に伝送するものをいう |
| 六 | 開閉所 | 構外から伝送される電気の開閉を行うが <mark>変成しない</mark> 所をいう |
...
| 九 | 電線路 | 発電所、蓄電所、変電所、開閉所及びこれらに類する場所並びに電気使用場所相互間の電線並びにこれを支持し、又は保蔵する工作物をいう |
| 十 | 電車線路 | 電車線及びこれを支持する工作物をいう |
| 十一 | 調相設備 | 無効電力を調整する電気機械器具をいう |
| 十二 | 弱電流電線 | 弱電流電気の伝送に使用する電気導体、絶縁物で被覆した電気導体又は絶縁物で被覆した上を保護被覆で保護した電気導体をいう |
| 十三 | 弱電流電線路 | 弱電流電線及びこれを支持し、又は保蔵する工作物をいう（電気通信事業法に規定する電気通信回線設備に該当するものを除く） |
| 十四 | 光ファイバケーブル | 光信号の伝送に使用する伝送媒体であって、保護被覆で保護したものをいう |
| 十五 | 光ファイバケーブル線路 | 光ファイバケーブル及びこれを支持し、又は保蔵する工作物をいう |
| 十六 | 支持物 | 木柱、鉄柱、鉄筋コンクリート柱及び鉄塔並びにこれらに類する工作物であって、電線又は弱電流電線若しくは光ファイバケーブルを支持することを主たる目的とするものをいう |
| 十七 | 連接引込線 | 引込線のうち、一需要場所の引込線から分岐して、支持物を経ないで他の需要場所の引込口に至る部分の電線をいう |
| 十八 | 配線 | 電気使用場所において施設する電線（電気機械器具内の電線及び電線路の電線を除く） |
