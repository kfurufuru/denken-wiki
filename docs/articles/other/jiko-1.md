...
??? question "セルフチェック: 報告規則第1条第1項が、自前で用語を定義せず「電気事業法等の例による」とわざわざ宣言しているのは何のためか。"
    **上位法（電気事業法）で既に定義済みの語彙をそのまま継承し、報告規則の中で定義が重複・矛盾するのを防ぐため。** だから第1項は、電気事業法／電気事業法施行令／電気事業法施行規則の3法令の用語の例によると宣言し、報告規則固有に区切りたい用語だけを第2項で独自定義する。「参照3法令の暗記」ではなく"なぜ継承するのか（定義の齟齬回避）"が核心。

??? question "セルフチェック: 「電気火災事故」「破損事故」などの用語が、第1項で継承せず報告規則 第1条第2項で独自定義されているのはなぜか。"
    **これらは"どこからを報告対象とするか"という報告手続上の区切りを新たに引く必要がある用語で、上位法には対応する定義が無いから第2項で独自に定義する。** 「主要電気工作物」「電気火災事故」「破損事故」はすべて報告規則 第1条第2項（三号・四号・五号）。第3条で「事故が発生したら報告する」と書ける前提として、本条が報告対象の射程を確定している。「第2項という場所の暗記」ではなく"なぜ第1項の継承で済まないのか"が核心。
...
??? question "セルフチェック: 「電気事業者」の定義は報告規則の中に書かれているか。書かれていないとしたら、その意味はどこから来て、なぜそうなっているのか。"
    報告規則自体には「電気事業者」の定義はない。報告規則第1条第1項の「用語の例による」により **電気事業法第2条** の定義をそのまま借りて読む。報告規則側で重複定義しないのは、省令ごとに同じ語を定義し直すと語彙が衝突・矛盾する恐れがあるため。「定義の場所の暗記」ではなく"なぜ自前で定義しないのか（齟齬回避）"が核心。
...
??? info "監修ログ（2026-05-09 ゴールドスタンダード v2.3 準拠）"
    **執筆**: 編者 / Claude Opus 4.7（テンプレ準拠改修）
    **監修パス**:
