...
*最終確認: 2026-05-09 | ステータス: v2.1（R5上問2 実出題実績を反映） | 条文番号: ✅ 一次ソース照合済（eGov 報告規則 第1条 ArticleCaption=「定義」） | 出題実績: ✅ R05上問2（穴埋・第1条第2項四・五・七号 + 第3条複合）を一次問題文で照合済 | テンプレ世代: ゴールドスタンダードv2.3準拠（3.4節SVG・5観点・物理形象は exclude） | [バージョニング基準](../../reference/versioning.md)*
