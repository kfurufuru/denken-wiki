...
!!! note "📊 試験対策メタ"
    **出題頻度**: ❄️（過去14年で単独穴埋め出題ゼロ・ただし**第3条等で使う用語の前提**として間接参照される）

    **重要度**: **C**（基本・第3〜5条の論点理解の基盤）

    **直近出題**: — （単独出題なし。H24 問3 は「報告規則は何法に基づくか」を問うが、本条の論点ではなく**規則体系**の論点 → §6 参照）

> 電気関係報告規則 第1条は、本省令で使用する用語の意味を統一する**定義条文**。第1項で「電気事業法・施行令・施行規則の用語例による」と宣言し、第2項で本規則固有の14用語（**主要電気工作物／電気火災事故／破損事故／供給支障事故／発電支障事故／放電支障事故／PCB含有電気工作物**等）を定義する。第3条以降の事故報告・公害報告・届出規定で使う **語彙の土台** に当たる。
...
!!! tip "なぜこのマップを冒頭に置くか"
    第1条は **単独で問われる頻度はほぼゼロ** だが、第3条以降の事故報告・公害報告で使う **「主要電気工作物」「電気火災事故」「破損事故」「供給支障事故」** の語彙が本条で定義されている。第3条の論点を正しく理解するには、本条の定義語の射程を先に把握する必要がある。

### 報告規則 第1〜5条の役割分担

| 条文 | 内容 | 性格 | 試験での問われ方 |
|------|------|------|------------------|
| **第1条**（本条）| **定義**（用語の意味） | 定義規定 | 単独穴埋め出題ゼロ・**間接参照**のみ |
...
- **R08 出題予測**: 単独穴埋めは依然として低確率（≤5%）。ただし第3条の論述問題で「電気火災事故とは何か」「主要電気工作物の範囲は」と問われる際の **定義根拠** として第1条が背景に立つ
...
| **四** | **電気火災事故** | **漏電・短絡・せん絡その他の電気的要因** で建造物等に火災が発生 |
| **五** | **破損事故** | 電気工作物の **変形・損傷・破壊** で機能が低下又は喪失 |
| 六 | 主要電気工作物の破損事故 | 別告示の主要電気工作物を構成する設備の破損事故 |
| **七** | **供給支障事故** | **破損事故又は誤操作** により電気の供給が停止 |
...
!!! note "本問は学習用の構成問題"
    第1条第1項の単独穴埋めは過去14年で実出題ゼロ。本問は **教育的補強として** 構成したもの。R08 でも単独出題確率は低いが、第3条の論述で背景知識として参照される可能性はある。
...
??? info "監修ログ（2026-05-09 ゴールドスタンダード v2.3 準拠）"
    ...
    **監修パス**:
    ...
    - **過去問実績**: kakomon DB照合 — 第1条単独出題ゼロを確認。H24 問3 は規則全体の上位法を問う論点で、本条の論点ではない（→§5）
...
*最終確認: 2026-05-09 | ステータス: v2.0（重大訂正：目的→定義） | 条文番号: ✅ 一次ソース照合済（eGov 報告規則 第1条 ArticleCaption=「定義」） | 出題実績: ✅ kakomon DB照合済（単独実出題ゼロを確認） | テンプレ世代: ゴールドスタンダードv2.3準拠（出題稀のため §3.4SVG・5観点・物理形象は exclude） | [バージョニング基準](../../reference/versioning.md)*
