...
| 一般用電気工作物 | いっぱんようでんきこうさくぶつ | 低圧（600V以下）受電の需要設備＋小規模発電設備（出力が経済産業省令で定める出力**未満**＝太陽電池は10kW未満 等）（電気事業法第38条第1項） | 第二種電気工事士の主担当範囲。旧「50kW未満＝一般用」は2022年改正（令和5年3月施行）で廃止され、10kW以上50kW未満は**小規模事業用電気工作物**に移行 |
...
- **2026-08-28 監査是正**（ChatGPT/Fable 監査 → Claude 一次照合）: 用語集の一般用電気工作物の定義を現行法に是正（旧「600V以下受電・50kW未満」→ 低圧受電の需要設備＋小規模発電設備〔出力が省令で定める出力**未満**〕。10kW以上50kW未満は2022年改正で**小規模事業用電気工作物**へ移行）。典拠: e-Gov XML 第38条第1項。
