...
> 電気工事士法における **「電気工事」「一般用電気工作物等」「自家用電気工作物」「軽微な工事」** の用語を定義する条文。第3条の資格区分（第一種／第二種）が **どの工作物に適用されるか** を確定する前提条文として機能する。試験では **軽微な工事の具体例** と **500kW境界での電気事業法第47条への切替** がひっかけとして頻出する。
...
- **500kW境界**: 500kW以上の自家用は電気工事士法の対象外 → **電気事業法第47条**（工事計画の認可）の管轄に切替
...
<text x="150" y="220" text-anchor="middle" font-size="11" fill="#1b5e20">600V以下受電</text>
<text x="150" y="240" text-anchor="middle" font-size="11" fill="#1b5e20">家庭・小規模事業所</text>
<text x="150" y="270" text-anchor="middle" font-size="13" font-weight="700" fill="#1b5e20">第二種 以上</text>
<text x="150" y="295" text-anchor="middle" font-size="10" fill="#2e7d32">が作業可</text>
...
<text x="400" y="220" text-anchor="middle" font-size="11" fill="#f57f17">最大電力 500kW未満</text>
<text x="400" y="240" text-anchor="middle" font-size="11" fill="#f57f17">中規模工場・ビル</text>
<text x="400" y="270" text-anchor="middle" font-size="13" font-weight="700" fill="#f57f17">第一種 のみ</text>
<text x="400" y="295" text-anchor="middle" font-size="10" fill="#f9a825">（認定は限定範囲）</text>
<rect x="540" y="160" width="220" height="170" rx="14" fill="url(#g2out)" stroke="#616161" stroke-width="2.5" filter="url(#sh2a)"/>
...
<text x="650" y="220" text-anchor="middle" font-size="11" fill="#424242">500kW以上の自家用</text>
<text x="650" y="240" text-anchor="middle" font-size="11" fill="#424242">大規模工場・発変電所</text>
<text x="650" y="265" text-anchor="middle" font-size="11" font-weight="700" fill="#424242">電気事業法 第47条</text>
<text x="650" y="282" text-anchor="middle" font-size="10" fill="#424242">（工事計画の認可）</text>
<text x="650" y="300" text-anchor="middle" font-size="10" fill="#424242">の管轄に切替</text>
...
| **管轄外の切替先** | 500kW以上 → **電気事業法第47条**（工事計画認可） |
...
??? question "セルフチェック: 第一種電気工事士は800kWの自家用工作物の工事ができるか？"
    **できない**。電気工事士法第2条の「自家用電気工作物」は **500kW未満** に限定されており、500kW以上は本法の対象外（電気事業法第47条の工事計画認可制度の管轄）。第一種でも500kW以上は工事不可という点は **R05上問3** をはじめ繰り返し問われている。
...
!!! tip "暗記の核心キーワード"
    ...
    - **500kW未満** = 第2条が射程に含む自家用の上限（500kW以上は電気事業法第47条管轄）
...
| 原文ブロック | 意味 | 試験のポイント |
|---|---|---|
| 「『一般用電気工作物等』とは」 | 一般用電気工作物 ＋ 小規模事業用電気工作物 の合成概念 | 単純な「一般用」ではなく **「等」付き**。小規模事業用（出力10kW未満の太陽光等）を含む |
| 「電気事業法第38条第1項に規定する」 | 上位定義は電気事業法側 | 工事士法は電気事業法の **下位** ではなく **参照** 関係。定義の出典が他法 |
| 「『自家用電気工作物』とは…**最大電力500kW以上の需要設備**…**を除く**」 | 自家用のうち **大規模設備は除外** | 第2条の自家用 = 500kW未満。500kW以上は電気事業法第47条の管轄 |
| 「発電所、蓄電所、変電所」も除外 | 規模を問わず発変電設備は対象外 | 「家庭の太陽光なら一般用、業務用太陽光なら自家用」とは限らない。発電所相当は本条対象外 |
| 「『電気工事』とは…設置し、又は変更する工事をいう」 | 動作範囲は **設置／変更** | 「修理」「保守」は条文上明示されず、解釈で別扱いになる |
| 「**ただし、政令で定める軽微な工事を除く**」 | 除外規定（資格不要の作業領域） | **政令委任**（電気工事士法施行令第1条）。差込接続器接続・電球交換・30VA以下変圧器接続等 |
| 「『電気工事士』とは…第一種電気工事士及び…第二種電気工事士をいう」 | 工事士は **第一種＋第二種** の2種類のみ | 認定電気工事従事者・特種電気工事資格者は「電気工事士」ではない（別の資格） |
...
500kW以上の自家用電気工作物は、規模が大きく **工事計画段階での事前審査** が安全確保に不可欠。そこで **電気事業法第47条** が「工事計画の認可」を要求する制度を別に持っている。電気工事士法と電気事業法第47条が **二重に規制すると過剰** になるため、第2条は500kW以上を **明示的に除外** して役割分担している。

| 規模 | 担当法 | 規制の重点 |
|------|--------|-----------|
| 一般用電気工作物等 | 電気工事士法 第2条 | **施工者の資格** |
| 自家用電気工作物（500kW未満） | 電気工事士法 第2条 | **施工者の資格（第一種限定）** |
| 自家用電気工作物（500kW以上） | **電気事業法 第47条** | **工事計画の認可（事前審査）** |
...
flowchart TD
    ...
    Q3 -->|自家用<br/>500kW以上| Out2[電気事業法第47条管轄]
    R1 --> Q4{軽微な<br/>工事に該当?}
    R2 --> Q4
...
**読み解き**: 第2条は **3つのゲート**（工作物該当／設置変更／規模区分）と **1つの除外**（軽微な工事）で「電気工事士の必要性」を判定する構造。500kW以上は電気事業法第47条の管轄に **横にスライド** する点が、本条の射程を理解する核心。
...
<text x="610" y="126" text-anchor="middle" font-size="10" fill="#bf360c">電気事業法 第47条</text>
<text x="610" y="146" text-anchor="middle" font-size="11" font-weight="700" fill="#bf360c">工事計画の認可</text>
...
**読み解き**: 横軸（最大電力）で規制法が変わる。500kWは **電気工事士法と電気事業法第47条の境界線**。第一種電気工事士の資格を持っていても、500kW以上は工事士法の射程外なので工事不可。「**第一種なら何でもできる**」という思い込みが頻出ひっかけ。
...
| **電気事業法 第47条** | 工事計画の認可対象（500kW以上の自家用等） | **第2条が除外した領域** の規制 |
...
| # | ❌ 誤った認識 | ✅ 正しい認識 |
|---|--------------|--------------|
| 1 | 第一種電気工事士なら自家用すべての工事ができる | 第2条で自家用は **500kW未満** に限定。500kW以上は **電気事業法第47条** の管轄で第一種でも工事不可 |
...
!!! abstract "問題2: 自家用電気工作物の上限"
    第2条第2項では、「自家用電気工作物」の定義から（　ア　）の需要設備が除外されている。これに該当する大規模需要設備の工事は、（　イ　）法 第47条の工事計画の認可制度の管轄となる。

??? success "解答"
    - ア = ==**最大電力500kW以上**==
    - イ = ==**電気事業**==

    500kW境界が電気工事士法と電気事業法第47条の **規制切替点**。第一種電気工事士でも500kW以上は工事できない核心ポイント。
...
| 誤った記述 | 正しい記述 | なぜ違うか |
|---|---|---|
| 「第一種電気工事士は自家用電気工作物すべての工事ができる」 | **500kW未満** の自家用のみ。500kW以上は電気事業法第47条管轄 | 第2条第2項が500kW以上を **明示的に除外** |
| 「電球交換は電気工事に該当するので電気工事士が必要」 | **軽微な工事**（政令第1条）として除外され、資格不要 | 「設置・変更」に該当しても軽微な工事除外規定が優先 |
| 「電気工事士には第一種・第二種・認定・特種が含まれる」 | 第2条第4項の電気工事士は **第一種＋第二種のみ** | 認定・特種は「電気工事士」ではなく別の資格区分 |
| 「軽微な工事の上限は100V 30A」 | **30VA**（100V換算で約0.3A） | 「30A（3kVA）」との混同が定番ひっかけ |
| 「軽微な工事の判定は規模で決まる」 | **危険性・技能難度** で決まる（規模ではない） | 政令第1条は具体的な作業内容を列挙し、規模基準は補助 |
| 「軽微な工事の具体例は第2条本文に列挙されている」 | 第2条は政令委任のみ。具体は **電気工事士法施行令第1条** | 法律は委任、政令で具体化する典型的な構造 |
| 「家庭の太陽光は必ず一般用電気工作物」 | 出力10kW未満なら「**小規模事業用電気工作物**」として「一般用電気工作物**等**」に含む | 令和5年改正で「等」が追加された |
| 「電気工事には修理・保守も含む」 | 第2条第3項は「**設置し、又は変更する工事**」のみ規定 | 修理・保守は条文上の明示なし（解釈で別扱い） |
...
- [ ] **500kW** = 自家用の上限（500kW以上は電気事業法第47条管轄）
...
- [ ] なぜ500kWで切るか = **電気事業法第47条の工事計画認可** との **役割分担**
...
*最終確認: 2026-05-05 | ステータス: v2.0（kijun/58.md v2.2＋koji-shi-1.md v2.0準拠・14セクション完備・黄色マーカー運用ルール厳格化済） | [バージョニング基準](../../reference/versioning.md)*
