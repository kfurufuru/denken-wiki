...
| **試験での扱い** | 直近の問題で「**蓄電池**」「**電力貯蔵装置**」が選択肢に登場する可能性あり。**次回以降の出題で警戒すべき論点** |
...
*最終確認: 2026-05-10 | ステータス: v2.7（ChatGPTレビュー反映・PCB誤記訂正・第2項根拠修正・14号フロー化）｜ 条文番号: ✅ 一次ソース照合済（eGov 2026-05-10 第3条第1項表＋第2項本文）｜ 出題実績: ✅ kakomon DB 6件照合済（H26/R02/R05上/R06上/R07上/R07下）｜ 数値根拠: ✅ 速報24h／詳報30日＝**第3条第2項本文**に直接明記（eGov 一次照合）｜ [バージョニング基準](../../reference/versioning.md)*
