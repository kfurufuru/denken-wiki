...
!!! note "📊 試験対策メタ"
    **出題頻度**: 🔥🔥🔥🔥（過去14年で 6 回出題・法規分野の超頻出）

    **重要度**: A（重要必須・期限と起算点の暗記が核心）
...
*最終確認: 2026-05-05 | 過去問実績検証完了: 2026-05-05（kakomon.yml照合・事実誤り4件訂正済） | ステータス: v2.0（テンプレートゴールドスタンダード準拠） | [バージョニング基準](../../reference/versioning.md)*
