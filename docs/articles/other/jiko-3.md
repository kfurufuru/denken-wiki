...
!!! success "数値検証 PASS（一次ソース照合済 2026-05-10）"
    本記事の数値は eGov 法令検索（lawid=340M50000400054 / 電気関係報告規則 昭和40年通商産業省令第54号 令和5年改正版）および電気事業法本文で全件一次照合済。

    | 数値 | 出典条項 | 検証結果 |
    |------|----------|----------|
    | 速報 24時間以内 | 電気関係報告規則 第3条第1項 | ✅ PASS |
    | 詳報 30日以内（様式第13） | 電気関係報告規則 第3条第1項 | ✅ PASS |
    | 上位法 第106条（報告の徴収） | 電気事業法 第106条 | ✅ PASS |
    | 規則制定根拠 昭和40年通商産業省令第54号 | 電気関係報告規則 制定根拠 | ✅ PASS |
    | 「入院を要する」感電事故閾値 | 電気関係報告規則 第3条第1項各号 | ✅ PASS |
    | PCB含有機器の漏油は全件報告 | 電気関係報告規則 第3条第1項各号 | ✅ PASS |
