...
!!! abstract "📊 試験対策メタ"
    - **出題頻度**: 🔥🔥🔥🔥（過去14年で 5 回出題：H23問6・H27問9・R01問9・R05下問7／用語定義は分散型電源テーマの基礎で頻出）
...
!!! note "出典・版数"
    電気設備の技術基準の解釈（経済産業省が省令の解釈として示すもの・最新版）第220条第1項 — eGov 法令API 未登録のため、一次ソース（経産省告示PDF）で 2026-06-08 一次照合。**典拠**: 電気設備の技術基準の解釈（制定 20130215商局第4号）第220条。記事 template_version: 2.7 ／ 本ページ version: v1.0。R01問9・H23問6 の選択肢文と整合確認済。
...
<text x="16" y="26" font-size="15" fill="#c62828" font-weight="700">① 単独運転 ＝ 危険（連系用遮断器が開かない）</text>
...
<text x="320" y="96" text-anchor="middle" font-size="10" fill="#c62828" font-weight="700">連系用遮断器（閉）</text>
...
<text x="318" y="306" text-anchor="middle" font-size="10" fill="#2e7d32" font-weight="700">連系用遮断器（開＝解列）</text>
...
<p style="font-size:13px;color:#666;margin-top:4px">単独運転は連系用遮断器が開かず、分散型電源が系統側の線路（他需要家・作業者がいる側）へ給電し続ける＝感電・機器損傷の危険。検出したら速やかに解列し、自分の構内負荷だけに給電する自立運転へ移行する。</p>
...
### 実際の検出回路 — 保護リレー（受動）＋擾乱注入（能動）

<div><svg viewBox="0 0 760 330" xmlns="http://www.w3.org/2000/svg" width="100%" preserveAspectRatio="xMidYMid meet">
<defs>
<marker id="det220c-red" markerWidth="9" markerHeight="9" refX="7" refY="3" orient="auto"><path d="M0,0 L7,3 L0,6 Z" fill="#c62828"/></marker>
<marker id="det220c-purple" markerWidth="9" markerHeight="9" refX="7" refY="3" orient="auto"><path d="M0,0 L7,3 L0,6 Z" fill="#6a1b9a"/></marker>
<marker id="det220c-blue" markerWidth="9" markerHeight="9" refX="7" refY="3" orient="auto"><path d="M0,0 L7,3 L0,6 Z" fill="#1565c0"/></marker>
</defs>

<!-- main single line y=60 -->
<line x1="57" y1="60" x2="124" y2="60" stroke="#444" stroke-width="2"/>
<circle cx="44" cy="60" r="13" fill="#fff" stroke="#444" stroke-width="1.6"/>
<path d="M37 60 q3.5 -6 7 0 q3.5 6 7 0" fill="none" stroke="#444" stroke-width="1.4"/>
<text x="44" y="86" text-anchor="middle" font-size="10" fill="#333">電力系統</text>
<circle cx="124" cy="60" r="3.4" fill="#444"/>
<text x="124" y="44" text-anchor="middle" font-size="10" fill="#333" font-weight="700">連系点(PCC)</text>
<!-- VT -->
<line x1="124" y1="60" x2="124" y2="84" stroke="#1565c0" stroke-width="1.6"/>
<circle cx="124" cy="93" r="7" fill="none" stroke="#1565c0" stroke-width="1.4"/>
<circle cx="124" cy="105" r="7" fill="none" stroke="#1565c0" stroke-width="1.4"/>
<text x="140" y="95" font-size="10" fill="#1565c0" font-weight="700">VT</text>
<text x="140" y="107" font-size="9" fill="#1565c0">電圧・周波数を計測</text>
<!-- CB -->
<line x1="124" y1="60" x2="208" y2="60" stroke="#444" stroke-width="2"/>
<rect x="208" y="50" width="26" height="20" rx="2" fill="#fff" stroke="#c62828" stroke-width="1.6"/>
<text x="221" y="64" text-anchor="middle" font-size="10" fill="#c62828" font-weight="700">CB</text>
<text x="221" y="42" text-anchor="middle" font-size="9" fill="#555">連系用遮断器</text>
<!-- PCS -->
<line x1="234" y1="60" x2="324" y2="60" stroke="#444" stroke-width="2"/>
<rect x="324" y="40" width="76" height="40" rx="3" fill="#fff" stroke="#2e7d32" stroke-width="1.8"/>
<line x1="330" y1="76" x2="396" y2="44" stroke="#2e7d32" stroke-width="1.4"/>
<text x="338" y="72" font-size="11" fill="#2e7d32" font-weight="700">=</text>
<text x="386" y="56" font-size="11" fill="#2e7d32" font-weight="700">~</text>
<text x="362" y="33" text-anchor="middle" font-size="10" fill="#2e7d32" font-weight="700">PCS（インバータ）</text>
<!-- load -->
<line x1="400" y1="60" x2="486" y2="60" stroke="#444" stroke-width="2"/>
<rect x="486" y="50" width="76" height="20" rx="2" fill="#fff" stroke="#444" stroke-width="1.4"/>
<text x="524" y="64" text-anchor="middle" font-size="10" fill="#333">構内負荷</text>

<!-- VT -> relay -->
<line x1="124" y1="113" x2="124" y2="182" stroke="#1565c0" stroke-width="1.6" marker-end="url(#det220c-blue)"/>
<text x="138" y="150" font-size="9.5" fill="#1565c0">計測値を常時監視</text>
<!-- trip arrow relay -> CB (visual only) -->
<line x1="224" y1="182" x2="223" y2="72" stroke="#c62828" stroke-width="1.8" stroke-dasharray="5 3" marker-end="url(#det220c-red)"/>
<text x="236" y="106" font-size="10" fill="#c62828" font-weight="700">trip</text>

<!-- relay box (passive) -->
<rect x="30" y="182" width="276" height="104" rx="6" fill="#eef3ff" stroke="#1565c0" stroke-width="1.5"/>
<text x="42" y="202" font-size="12" fill="#1565c0" font-weight="700">系統連系用保護リレー（受動的に観測）</text>
<text x="42" y="222" font-size="11" fill="#333">電圧：OVR(過電圧)／UVR(不足電圧)</text>
<text x="42" y="240" font-size="11" fill="#333">周波数：OFR(過周波数)／UFR(不足周波数)</text>
<text x="42" y="258" font-size="11" fill="#333">単独運転検出：位相跳躍・周波数変化率 など</text>
<text x="42" y="278" font-size="11" fill="#c62828" font-weight="700">異常検出時 → trip 信号で CB を開放（＝解列）</text>

<!-- active box -->
<rect x="332" y="182" width="296" height="104" rx="6" fill="#f7edf7" stroke="#6a1b9a" stroke-width="1.5"/>
<text x="344" y="202" font-size="12" fill="#6a1b9a" font-weight="700">能動的方式：擾乱を注入（仕掛ける）</text>
<text x="344" y="222" font-size="10.5" fill="#333">PCSが出力に微小擾乱（無効電力変動／周波数シフト）を常時重畳</text>
<text x="344" y="240" font-size="10.5" fill="#333">系統ありは大系統が吸収し効かない</text>
<text x="344" y="258" font-size="10.5" fill="#333">単独運転になると V・f が発散</text>
<text x="344" y="276" font-size="10.5" fill="#c62828" font-weight="700">→ 同じ保護リレーが検出（受動の不感帯を補う）</text>
<!-- injection arrow active -> PCS -->
<line x1="388" y1="182" x2="388" y2="84" stroke="#6a1b9a" stroke-width="1.8" marker-end="url(#det220c-purple)"/>
<text x="402" y="140" font-size="9.5" fill="#6a1b9a" font-weight="700">擾乱を注入</text>

<line x1="16" y1="302" x2="744" y2="302" stroke="#eee" stroke-width="1"/>
<text x="380" y="322" text-anchor="middle" font-size="12" fill="#333" font-weight="700">受動＝測って待つ／能動＝わざと揺らす。いずれも最終的に【保護リレー → 遮断器(CB)を開放】で解列する。</text>
</svg></div>

<p style="font-size:13px;color:#666;margin-top:4px">実装では、連系点(PCC)の電圧・周波数を計器用変成器(VT)で常時計測し、系統連系用保護リレー（OVR/UVR・OFR/UFR・位相跳躍/周波数変化率 など）が異常を検出すると連系用遮断器(CB)を開いて解列する＝これが受動的方式。能動的方式は PCS が出力に微小な擾乱（無効電力変動・周波数シフト 等）を常時重畳し、系統ありは効かないが単独運転になると電圧・周波数が発散するので、同じ保護リレーが確実に検出できる（受動の不感帯を補う）。</p>
...
| 重要度 | ❌ よくある誤り | ✅ 正しい理解 |
|:---:|---|---|
| 🔴 致命 | 逆潮流＝**無効電力**が系統へ流れる | 正しくは **有効電力**。方向は **構内→系統** |
| 🔴 致命 | 単独運転と自立運転は同じ | 供給先が違う。**単独＝線路（系統）負荷へ（異常）／自立＝構内負荷のみ（正常・意図的）** |
| 🔴 致命 | 逆潮流と逆充電は同じ | **逆潮流＝平常時の有効電力流出／逆充電＝系統停電中に加圧するが有効電力は流さない** |
| 🟡 注意 | 転送遮断＝分散型電源が **自ら** 異常を検知して遮断 | **系統側の信号を通信で受けて** 遮断（自ら検知は能動的単独運転検出） |
| 🟡 注意 | 単独運転検出は受動的方式だけでよい | **受動的＋能動的の両方** が原則（[第227条](227.md)・[第229条](229.md)） |
| 🟢 軽微 | 解列はめったに使わない難語 | 「解列」＝系統から **切り離す** こと（「連系」の反対）。定義は単純で頻出 |
...
- **2026-08-28 出題実績を SoT と整合**（Claude・kakomon.yml 突合）: メタを 4回→**5回** に是正（SoT: H23問6・H27問9・R01問9・R04下問8・R05下問7）。
