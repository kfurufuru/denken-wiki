...
<div><svg viewBox="0 0 760 350" xmlns="http://www.w3.org/2000/svg" width="100%" preserveAspectRatio="xMidYMid meet">
<defs>
<marker id="det220c-red" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6 Z" fill="#c62828"/></marker>
<marker id="det220c-purple" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6 Z" fill="#6a1b9a"/></marker>
<marker id="det220c-blue" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6 Z" fill="#1565c0"/></marker>
</defs>
<text x="16" y="24" font-size="14" fill="#333" font-weight="700">実際の検出回路 — 受動＝保護リレーで観測／能動＝PCSが擾乱を注入。どちらも同じ遮断器を開いて解列</text>

<!-- main single line y=92 -->
<line x1="62" y1="92" x2="130" y2="92" stroke="#444" stroke-width="2"/>
<circle cx="46" cy="92" r="14" fill="#fff" stroke="#444" stroke-width="1.6"/>
<path d="M38 92 q4 -7 8 0 q4 7 8 0" fill="none" stroke="#444" stroke-width="1.4"/>
<text x="46" y="120" text-anchor="middle" font-size="10" fill="#333">電力系統</text>
<circle cx="130" cy="92" r="3.4" fill="#444"/>
<text x="130" y="74" text-anchor="middle" font-size="10" fill="#333" font-weight="700">連系点(PCC)</text>
<!-- VT tap -->
<line x1="130" y1="92" x2="130" y2="120" stroke="#444" stroke-width="1.6"/>
<circle cx="130" cy="129" r="8" fill="none" stroke="#1565c0" stroke-width="1.4"/>
<circle cx="130" cy="141" r="8" fill="none" stroke="#1565c0" stroke-width="1.4"/>
<text x="146" y="130" font-size="10" fill="#1565c0" font-weight="700">VT</text>
<text x="146" y="143" font-size="9" fill="#1565c0">電圧・周波数を計測</text>
<!-- to CB -->
<line x1="130" y1="92" x2="214" y2="92" stroke="#444" stroke-width="2"/>
<rect x="214" y="82" width="26" height="20" rx="2" fill="#fff" stroke="#c62828" stroke-width="1.6"/>
<text x="227" y="96" text-anchor="middle" font-size="10" fill="#c62828" font-weight="700">CB</text>
<text x="227" y="116" text-anchor="middle" font-size="9" fill="#555">連系用遮断器</text>
<!-- to PCS -->
<line x1="240" y1="92" x2="330" y2="92" stroke="#444" stroke-width="2"/>
<rect x="330" y="72" width="78" height="40" rx="3" fill="#fff" stroke="#2e7d32" stroke-width="1.8"/>
<line x1="336" y1="108" x2="402" y2="76" stroke="#2e7d32" stroke-width="1.4"/>
<text x="344" y="104" font-size="11" fill="#2e7d32" font-weight="700">=</text>
<text x="392" y="88" font-size="11" fill="#2e7d32" font-weight="700">~</text>
<text x="369" y="126" text-anchor="middle" font-size="10" fill="#2e7d32" font-weight="700">PCS（インバータ）</text>
<!-- to load -->
<line x1="408" y1="92" x2="496" y2="92" stroke="#444" stroke-width="2"/>
<rect x="496" y="82" width="72" height="20" rx="2" fill="#fff" stroke="#444" stroke-width="1.4"/>
<text x="532" y="96" text-anchor="middle" font-size="10" fill="#333">構内負荷</text>

<!-- relay box (passive) -->
<rect x="34" y="196" width="270" height="92" rx="6" fill="#eef3ff" stroke="#1565c0" stroke-width="1.5"/>
<text x="46" y="216" font-size="12" fill="#1565c0" font-weight="700">系統連系用保護リレー（受動的に観測）</text>
<text x="46" y="236" font-size="11" fill="#333">電圧：OVR(過電圧)／UVR(不足電圧)</text>
<text x="46" y="254" font-size="11" fill="#333">周波数：OFR(過周波数)／UFR(不足周波数)</text>
<text x="46" y="272" font-size="11" fill="#333">単独運転検出：位相跳躍・周波数変化率 など</text>
<line x1="130" y1="149" x2="130" y2="196" stroke="#1565c0" stroke-width="1.6" marker-end="url(#det220c-blue)"/>
<text x="150" y="178" font-size="9.5" fill="#1565c0">計測値を常時監視</text>
<!-- trip to CB -->
<line x1="250" y1="196" x2="232" y2="104" stroke="#c62828" stroke-width="1.8" stroke-dasharray="5 3" marker-end="url(#det220c-red)"/>
<text x="262" y="138" font-size="10.5" fill="#c62828" font-weight="700">異常を検出 → trip → CB開放（解列）</text>

<!-- active box -->
<rect x="330" y="200" width="314" height="86" rx="6" fill="#f7edf7" stroke="#6a1b9a" stroke-width="1.5"/>
<text x="342" y="220" font-size="12" fill="#6a1b9a" font-weight="700">能動的方式：擾乱を注入（仕掛ける）</text>
<text x="342" y="240" font-size="10.5" fill="#333">PCSが出力に微小擾乱（無効電力変動／周波数シフト）を常時重畳</text>
<text x="342" y="258" font-size="10.5" fill="#333">系統ありは大系統が吸収し効かない</text>
<text x="342" y="276" font-size="10.5" fill="#333">単独運転になると V・f が発散 → 同じ保護リレーが検出（不感帯対策）</text>
<line x1="388" y1="200" x2="388" y2="114" stroke="#6a1b9a" stroke-width="1.8" marker-end="url(#det220c-purple)"/>
<text x="408" y="170" font-size="9.5" fill="#6a1b9a" font-weight="700">擾乱を注入</text>

<line x1="16" y1="304" x2="744" y2="304" stroke="#eee" stroke-width="1"/>
<text x="380" y="324" text-anchor="middle" font-size="12" fill="#333" font-weight="700">受動＝測って待つ／能動＝わざと揺らす。いずれも最終的に【保護リレー → 遮断器(CB)を開放】で解列する。</text>
</svg></div>
