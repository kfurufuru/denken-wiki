...
> **このセクションは §2 条文原文の 17-1表（接地抵抗値）と 17-3表（接地線太さ）を1表に圧縮した受験者向けサマリー**。条文準拠の正式な表は **[§2 条文原文（17-1表・17-3表）](#2-17-117-3)** を参照。
...
> 迷ったら「A＝高圧・特高」「B＝変圧器の混触防止」「C＝低圧300V超」「D＝低圧300V以下」で判定する。詳細な数値・線径・緩和規定は **§2 条文原文の17-1表・17-3表**（条文準拠）と §9（A/B 2層暗記表）を参照。
...
| **B種接地工事** | ==**2.6mm以上**== | **1.04kN以上** | ==高圧電路==と低圧電路を結合する変圧器 |
| **B種接地工事** | ==**2.6mm以上**== | **1.04kN以上** | **第108条に規定する特別高圧架空電線路** と低圧電路を結合する変圧器（特例） |
...
```mermaid
flowchart TD
    Start[接地工事を施したい機器] --> Q1{機器の種類は}
    Q1 -->|変圧器の中性点| B[B種接地<br/>抵抗 150÷Ig<br/>線径 2.6 or 4mm]
    Q1 -->|機器外箱| Q2{使用電圧は}
    Q2 -->|高圧・特別高圧| A[A種接地<br/>10Ω以下<br/>線径 2.6mm]
    Q2 -->|300V超 低圧| C[C種接地<br/>10Ω以下<br/>線径 1.6mm]
    Q2 -->|300V以下 低圧| D[D種接地<br/>100Ω以下<br/>線径 1.6mm]
    C --> ELB1{漏電遮断器<br/>0.5秒以内?}
    D --> ELB2{漏電遮断器<br/>0.5秒以内?}
...
<defs>
<filter id="sh17b" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="2" stdDeviation="2" flood-opacity="0.12"/></filter>
</defs>
<text x="400" y="24" text-anchor="middle" font-size="15" font-weight="700" fill="#212121">B種接地：高低圧混触時の低圧側対地電圧抑制</text>
<text x="400" y="42" text-anchor="middle" font-size="11" fill="#666">Ig × B種接地抵抗 ≤ 150V を満たすよう抵抗値を設計</text>
<rect x="40" y="80" width="200" height="120" rx="6" fill="#fff3e0" stroke="#e65100" stroke-width="2"/>
<text x="140" y="106" text-anchor="middle" font-size="12" font-weight="700" fill="#bf360c">高圧側</text>
<text x="140" y="128" text-anchor="middle" font-size="11" fill="#bf360c">6.6kV など</text>
<text x="140" y="156" text-anchor="middle" font-size="10" fill="#bf360c">1線地絡電流 Ig</text>
<text x="140" y="178" text-anchor="middle" font-size="10" fill="#bf360c">（数A〜数十A）</text>
<rect x="280" y="100" width="160" height="80" rx="6" fill="#e3f2fd" stroke="#0d47a1" stroke-width="2"/>
<text x="360" y="125" text-anchor="middle" font-size="13" font-weight="700" fill="#0d47a1">変圧器</text>
<text x="360" y="148" text-anchor="middle" font-size="10" fill="#1565c0">高低圧結合</text>
<text x="360" y="166" text-anchor="middle" font-size="10" fill="#1565c0">混触の可能性</text>
<rect x="480" y="80" width="200" height="120" rx="6" fill="#e8f5e9" stroke="#2e7d32" stroke-width="2"/>
<text x="580" y="106" text-anchor="middle" font-size="12" font-weight="700" fill="#1b5e20">低圧側</text>
<text x="580" y="128" text-anchor="middle" font-size="11" fill="#1b5e20">200V系・100V系</text>
<text x="580" y="156" text-anchor="middle" font-size="10" fill="#1b5e20">対地電圧上昇を</text>
<text x="580" y="178" text-anchor="middle" font-size="10" font-weight="700" fill="#1b5e20">150V 以下に抑制</text>
<line x1="240" y1="140" x2="280" y2="140" stroke="#37474f" stroke-width="2"/>
<line x1="440" y1="140" x2="480" y2="140" stroke="#37474f" stroke-width="2"/>
<line x1="580" y1="200" x2="580" y2="240" stroke="#1b5e20" stroke-width="3"/>
<rect x="510" y="240" width="140" height="40" rx="6" fill="#fff9c4" stroke="#f57f17" stroke-width="2"/>
<text x="580" y="266" text-anchor="middle" font-size="12" font-weight="700" fill="#f57f17">B種接地</text>
<line x1="580" y1="280" x2="580" y2="310" stroke="#37474f" stroke-width="3"/>
<line x1="500" y1="310" x2="660" y2="310" stroke="#3e2723" stroke-width="3"/>
<text x="580" y="334" text-anchor="middle" font-size="11" font-weight="700" fill="#3e2723">大地</text>
<rect x="40" y="240" width="220" height="80" rx="6" fill="#f5f5f5" stroke="#9e9e9e" stroke-width="1.5"/>
<text x="150" y="262" text-anchor="middle" font-size="11" font-weight="700" fill="#424242">設計式</text>
<text x="150" y="282" text-anchor="middle" font-size="11" fill="#424242">Ig × R ≤ 150V</text>
<text x="150" y="302" text-anchor="middle" font-size="11" font-weight="700" fill="#0d47a1">∴ R ≤ 150÷Ig Ω</text>
<rect x="280" y="240" width="220" height="80" rx="6" fill="#f5f5f5" stroke="#9e9e9e" stroke-width="1.5"/>
<text x="390" y="262" text-anchor="middle" font-size="11" font-weight="700" fill="#424242">緩和（自動遮断装置）</text>
<text x="390" y="282" text-anchor="middle" font-size="10" fill="#424242">動作時間 1秒超〜2秒以下：300÷Ig</text>
<text x="390" y="302" text-anchor="middle" font-size="10" fill="#424242">動作時間 1秒以下：600÷Ig</text>
</svg></div>
...
| **B種線太さ②** | 特別高圧電路と低圧電路を結合する変圧器・その他 → **4mm以上** |
| **A種引張強さ** | 1.04kN 以上 |
...
!!! tip "B種線太さの混同注意"
    「B種＝4mm一律」と単純化される設問もあるが、公式の17-3表は **2区分**：
...
- 電技解釈 第24条（高低圧混触防止）— B種接地の **数値根拠** （150V以下）の上位ロジック <!-- [要確認]: 24.md は未作成 -->
...
旧版wikiでは「§18登録」だった以下2件を、本セッションで「§17登録」に訂正済（一次ソース照合により本来の根拠条文が第17条であると判明）：

| 年度 | 問 | 内容 | 旧登録 | **新登録** |
|------|-----|------|-------|----------|
| R05上 | 問12 | B種接地工事の抵抗値及び常時流れる電流（計算） | §18 | **§17** |
| R05下 | 問11 | 需要設備付近で発生した1線地絡事故（計算） | §18 | **§17** |
...
- **2026-05-08 v3.0 全面再構築（条文番号誤記訂正）**: タイトル「A種接地工事」→ **「接地工事の種類及び施設方法」** に昇格。A〜D種統合構造で v2.4.3 完全準拠の再構築。
    ...
    - **構造**: v2.4.3 テンプレート完全準拠（18.mdと同一構成）。YAMLメタ宣言／隣接条文クラスタマップ（§0）／A〜D種統合SVG（§1）／17-1表＋17-3表（§2）／4種類のブロック分解（§3）／因果理解（§4）／Mermaid種別判定フロー＋A種保護動作＋B種混触防止SVG（§5）／施設形態3シーン（§6）／核心キーワード4語（§7）／適用範囲とELB緩和の適用一覧（§8）／A/B 2層暗記表（§9）／省令体系図（§10）／**条文別暗記マップ（§11）**／試験対策（5切り口・ひっかけ・穴埋め4問・派生問題3問・まぎらわしい選択肢／§12）／実務シーン3場面（§17）／関連条文（§18）／過去問実績（主軸15件＋kakomon更新ずれ訂正記録／§19）／用語集13語（§20）／最終チェック（§21）。
    - **kakomon.yml 訂正**: §18登録だった2件（R05上問12・R05下問11）を §17 に移行（本セッションで実施）。
