...
def self_test(facts: list[dict]) -> int:
    ...
    samples: dict[str, list[str]] = {
        ...
        "kairo-072-only-above-170kv": [
            "中性点直接接地式なら 69,000 × 0.72 = 49,680V が試験電圧になる。",
            "同じ69,000Vでも直接接地式は0.72倍で計算する。",
            "| 154kV変電 | 161,000V | × 0.72（中性点接地） | **115,920V** |",
        ],
        "henatsuki-kosho-to-saidai-shiyo": [
            "一次（22kV、特高≤60kV）× 1.25倍 = 27.5kV試験",
            "公称22kV の変圧器なら 22,000 × 1.25 = 27,500V。",
        ],
        "saidai-kyokyu-denatsu-not-a-term": [
            "| 高圧（600 V 超〜7,000 V 以下） | 最大供給電圧 × 1.5 倍 | 10,500 V |",
            "最大供給電圧 = 定格電圧の最大値（例：200 V 系なら最大 230 V 程度）。",
        ],
        "koatsu-has-no-10500-floor": [
            "高圧（600 V 超〜7,000 V 以下）は最低保証電圧 10,500 V である。",
            "7,000 V 以下の区分は下限 10,500 V が効く。",
        ],
        "tanso3sen-taichi-100v": [
            "- 省令第58条：使用電圧 **300V以下 + 対地電圧150V超**（200V単相3線・三相3線等）",
            "単相3線式100/200V は 0.2MΩ 以上とする。",
        ],
        ...
        "ippanyo-solar-limit-is-10kw": [
            "| 一般用電気工作物 | 家庭・小規模店舗の設備 | **受電電圧600V以下・出力50kW未満**の発電設備のみ持つ設備 |",
    ...
    negatives = [
        ...
        # 是正後の正しい記述（一般用の上限は10kW未満）。パターンは「50kW未満」を要求するので外れる。
